...
var index_1 = require('../../../../codegen/crm/tickets/index');
var configuration_1 = require('../../../../codegen/crm/tickets/configuration');
var TicketsDiscovery = (function (_super) {
    __extends(TicketsDiscovery, _super);
    function TicketsDiscovery(config) {
