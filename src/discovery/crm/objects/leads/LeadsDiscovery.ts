import { createConfiguration } from '../../../../../codegen/crm/objects/leads/configuration'
import {
  BasicApi,
  BatchApi,
  RequestContext,
  ...
  SearchApi,
  ServerConfiguration,
} from '../../../../../codegen/crm/objects/leads/index'
import { Observable } from '../../../../../codegen/crm/objects/leads/rxjsStub'
