...
var index_1 = require('../../../../codegen/crm/products/index');
var configuration_1 = require('../../../../codegen/crm/products/configuration');
var ProductsDiscovery = (function (_super) {
    __extends(ProductsDiscovery, _super);
    function ProductsDiscovery(config) {
