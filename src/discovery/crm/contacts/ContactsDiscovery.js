...
var index_1 = require('../../../../codegen/crm/contacts/index');
var configuration_1 = require('../../../../codegen/crm/contacts/configuration');
var ContactsDiscovery = (function (_super) {
    __extends(ContactsDiscovery, _super);
    function ContactsDiscovery(config) {
