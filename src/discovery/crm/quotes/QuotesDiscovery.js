...
var index_1 = require('../../../../codegen/crm/quotes/index');
var configuration_1 = require('../../../../codegen/crm/quotes/configuration');
var QuotesDiscovery = (function (_super) {
    __extends(QuotesDiscovery, _super);
    function QuotesDiscovery(config) {
