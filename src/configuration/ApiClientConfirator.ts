...
export class ApiClientConfirator {
    static getParams<RequestContextType extends IRequestContext, ResponseContextType>(config: IConfiguration) {
        let params = {}
    ...
    static getHeaderMiddleware<RequestContextType extends IRequestContext, ResponseContextType>() {
        return {
