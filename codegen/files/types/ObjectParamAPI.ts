...
export class ObjectFilesApi {
    ...
    public replace(param: FilesApiReplaceRequest, options?: Configuration): Promise<any> {
        return this.api.replace(param.fileId, param.userAgent, param.file, param.charsetHunch, param.options,  options).toPromise();
    }
    ...
    public upload(param: FilesApiUploadRequest, options?: Configuration): Promise<any> {
        return this.api.upload(param.userAgent, param.file, param.folderId, param.folderPath, param.fileName, param.charsetHunch, param.options,  options).toPromise();
    }
...
export class ObjectFoldersApi {
    ...
    public doSearch(param: FoldersApiDoSearchRequest, options?: Configuration): Promise<CollectionResponseFolder> {
        return this.api.doSearch(param.properties, param.after, param.before, param.limit, param.sort, param.id, param.createdAt, param.updatedAt, param.name, param.path, param.parentFolderId,  options).toPromise();
    }
