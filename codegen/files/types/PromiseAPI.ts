...
export class PromiseFilesApi {
    ...
    public doSearch(properties?: Array<string>, after?: string, before?: string, limit?: number, sort?: Array<string>, id?: string, createdAt?: Date, updatedAt?: Date, name?: string, path?: string, parentFolderId?: number, size?: number, height?: number, width?: number, encoding?: string, type?: string, extension?: string, url?: string, isUsableInContent?: boolean, allowsAnonymousAccess?: boolean, _options?: Configuration): Promise<CollectionResponseFile> {
        const result = this.api.doSearch(properties, after, before, limit, sort, id, createdAt, updatedAt, name, path, parentFolderId, size, height, width, encoding, type, extension, url, isUsableInContent, allowsAnonymousAccess, _options);
        return result.toPromise();
    }
     ...
     */
    public replace(fileId: string, userAgent?: string, file?: HttpFile, charsetHunch?: string, options?: string, _options?: Configuration): Promise<any> {
        const result = this.api.replace(fileId, userAgent, file, charsetHunch, options, _options);
        return result.toPromise();
    }
     ...
     */
    public upload(userAgent?: string, file?: HttpFile, folderId?: string, folderPath?: string, fileName?: string, charsetHunch?: string, options?: string, _options?: Configuration): Promise<any> {
        const result = this.api.upload(userAgent, file, folderId, folderPath, fileName, charsetHunch, options, _options);
        return result.toPromise();
    }
...
export class PromiseFoldersApi {
     ...
     */
    public doSearch(properties?: Array<string>, after?: string, before?: string, limit?: number, sort?: Array<string>, id?: string, createdAt?: Date, updatedAt?: Date, name?: string, path?: string, parentFolderId?: number, _options?: Configuration): Promise<CollectionResponseFolder> {
        const result = this.api.doSearch(properties, after, before, limit, sort, id, createdAt, updatedAt, name, path, parentFolderId, _options);
        return result.toPromise();
    }
