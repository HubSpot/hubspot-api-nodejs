...
__export(require('./CollectionResponseExternalUnifiedEvent'));
__export(require('./ErrorDetail'));
__export(require('./ExternalUnifiedEvent'));
__export(require('./ModelError'));
__export(require('./NextPage'));
__export(require('./Paging'));
var CollectionResponseExternalUnifiedEvent_2 = require('./CollectionResponseExternalUnifiedEvent');
var ErrorDetail_2 = require('./ErrorDetail');
var ExternalUnifiedEvent_2 = require('./ExternalUnifiedEvent');
...
var typeMap = {
    "CollectionResponseExternalUnifiedEvent": CollectionResponseExternalUnifiedEvent_2.CollectionResponseExternalUnifiedEvent,
    "ErrorDetail": ErrorDetail_2.ErrorDetail,
    "ExternalUnifiedEvent": ExternalUnifiedEvent_2.ExternalUnifiedEvent,
