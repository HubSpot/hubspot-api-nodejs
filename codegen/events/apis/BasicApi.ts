...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param sort 
     */
    public async eventsV3Events(after?: string, before?: string, eventType?: string, id?: Array<string>, limit?: number, objectId?: number, objectPropertyPropname?: any, objectType?: string, occurredAfter?: Date, occurredBefore?: Date, properties?: Array<string>, propertyPropname?: any, sort?: Array<string>, _options?: Configuration): Promise<RequestContext> {
    ...
    /**
     */
    public async eventsV3EventsEventTypes(_options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class BasicApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to eventsV3Events
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async eventsV3EventsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CollectionResponseExternalUnifiedEvent >> {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to eventsV3EventsEventTypes
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async eventsV3EventsEventTypesWithHttpInfo(response: ResponseContext): Promise<HttpInfo<VisibleExternalEventTypeNames >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
