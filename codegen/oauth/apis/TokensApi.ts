...
export class TokensApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param scope 
     */
    public async create(grantType?: string, code?: string, redirectUri?: string, clientId?: string, clientSecret?: string, refreshToken?: string, codeVerifier?: string, scope?: string, _options?: Configuration): Promise<RequestContext> {
