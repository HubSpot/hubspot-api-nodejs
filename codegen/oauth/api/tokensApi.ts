...
export class TokensApi {
     ...
     * @param refreshToken 
     */
    public getTokens (grantType?: string, code?: string, redirectUri?: string, clientId?: string, clientSecret?: string, refreshToken?: string) : Promise<{ response: http.IncomingMessage; body: Error;  }> {
