...
export class SubscriptionsApi {
     ...
     */
    public async deleteSubscription (subscriptionId: number, appId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        if (appId === null || appId === undefined) {
            throw new Error('Required parameter appId was null or undefined when calling deleteSubscription.');
        }
     ...
     */
    public async getSubscription (appId: number, subscriptionId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SubscriptionResponse;  }> {
        const localVarPath = this.basePath + '/webhooks/v3/{appId}/subscriptions/{subscriptionId}'
            .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)))
            .replace('{' + 'subscriptionId' + '}', encodeURIComponent(String(subscriptionId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'appId' is not null or undefined
        if (appId === null || appId === undefined) {
            throw new Error('Required parameter appId was null or undefined when calling getSubscription.');
        }
     ...
     * @param appId The ID of the target app.
     */
    public async getSubscriptions (appId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SubscriptionListResponse;  }> {
        ...
        // verify required parameter 'appId' is not null or undefined
        if (appId === null || appId === undefined) {
            throw new Error('Required parameter appId was null or undefined when calling getSubscriptions.');
        }
     ...
     */
    public async updateSubscription (subscriptionId: number, appId: number, subscriptionPatchRequest?: SubscriptionPatchRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SubscriptionResponse;  }> {
        const localVarPath = this.basePath + '/webhooks/v3/{appId}/subscriptions/{subscriptionId}'
            .replace('{' + 'subscriptionId' + '}', encodeURIComponent(String(subscriptionId)))
            .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'appId' is not null or undefined
        if (appId === null || appId === undefined) {
            throw new Error('Required parameter appId was null or undefined when calling updateSubscription.');
        }
