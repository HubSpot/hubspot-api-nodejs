...
export class DefaultApi {
     ...
     */
    public async create_2 (batchInputBlogAuthor: BatchInputBlogAuthor, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        ...
        if (batchInputBlogAuthor === null || batchInputBlogAuthor === undefined) {
            throw new Error('Required parameter batchInputBlogAuthor was null or undefined when calling create_2.');
        }
     ...
     * @param archived Specifies whether to update archived Blog Authors. Defaults to &#x60;false&#x60;.
     */
    public async update_3 (objectId: string, blogAuthor: BlogAuthor, archived?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BlogAuthor;  }> {
        const localVarPath = this.basePath + '/cms/v3/blogs/authors/{objectId}'
            .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'blogAuthor' is not null or undefined
        if (blogAuthor === null || blogAuthor === undefined) {
            throw new Error('Required parameter blogAuthor was null or undefined when calling update_3.');
        }
