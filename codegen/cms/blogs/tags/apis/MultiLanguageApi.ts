...
export class MultiLanguageApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async createLangVariation(tagCloneRequestVNext: TagCloneRequestVNext, _options?: Configuration): Promise<RequestContext> {
        ...
        if (tagCloneRequestVNext === null || tagCloneRequestVNext === undefined) {
            throw new RequiredError("MultiLanguageApi", "createLangVariation", "tagCloneRequestVNext");
        }
...
export class MultiLanguageApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createLangVariationWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Tag >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
