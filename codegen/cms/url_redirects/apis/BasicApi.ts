...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async archive(urlRedirectId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (urlRedirectId === null || urlRedirectId === undefined) {
            throw new RequiredError("BasicApi", "archive", "urlRedirectId");
        }
     ...
     * @param updatedBefore 
     */
    public async cmsUrlRedirectsV3(after?: string, archived?: boolean, createdAfter?: Date, createdAt?: Date, createdBefore?: Date, limit?: number, sort?: Array<string>, updatedAfter?: Date, updatedAt?: Date, updatedBefore?: Date, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async cmsUrlRedirectsV3_1(urlMappingCreateRequestBody: UrlMappingCreateRequestBody, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (urlMappingCreateRequestBody === null || urlMappingCreateRequestBody === undefined) {
            throw new RequiredError("BasicApi", "cmsUrlRedirectsV3_1", "urlMappingCreateRequestBody");
        }
    ...
    public async getById(urlRedirectId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'urlRedirectId' is not null or undefined
        if (urlRedirectId === null || urlRedirectId === undefined) {
            throw new RequiredError("BasicApi", "getById", "urlRedirectId");
        }
    ...
    public async update(urlRedirectId: string, urlMapping: UrlMapping, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'urlRedirectId' is not null or undefined
        if (urlRedirectId === null || urlRedirectId === undefined) {
            throw new RequiredError("BasicApi", "update", "urlRedirectId");
        }


        // verify required parameter 'urlMapping' is not null or undefined
        if (urlMapping === null || urlMapping === undefined) {
            throw new RequiredError("BasicApi", "update", "urlMapping");
        }
...
export class BasicApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to cmsUrlRedirectsV3
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async cmsUrlRedirectsV3WithHttpInfo(response: ResponseContext): Promise<HttpInfo<CollectionResponseWithTotalUrlMappingForwardPaging >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to cmsUrlRedirectsV3_1
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async cmsUrlRedirectsV3_1WithHttpInfo(response: ResponseContext): Promise<HttpInfo<UrlMapping >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
