...
export class MultiLanguageApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param attachToLangPrimaryRequestVNext 
     */
    public async attachToLangGroup_1(attachToLangPrimaryRequestVNext: AttachToLangPrimaryRequestVNext, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'attachToLangPrimaryRequestVNext' is not null or undefined
        if (attachToLangPrimaryRequestVNext === null || attachToLangPrimaryRequestVNext === undefined) {
            throw new RequiredError("MultiLanguageApi", "attachToLangGroup_1", "attachToLangPrimaryRequestVNext");
        }
    ...
    public async createLangVariation(contentLanguageCloneRequestVNext: ContentLanguageCloneRequestVNext, _options?: Configuration): Promise<RequestContext> {
        ...
        if (contentLanguageCloneRequestVNext === null || contentLanguageCloneRequestVNext === undefined) {
            throw new RequiredError("MultiLanguageApi", "createLangVariation", "contentLanguageCloneRequestVNext");
        }
     ...
     * @param contentLanguageCloneRequestVNext 
     */
    public async createLangVariation_2(contentLanguageCloneRequestVNext: ContentLanguageCloneRequestVNext, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'contentLanguageCloneRequestVNext' is not null or undefined
        if (contentLanguageCloneRequestVNext === null || contentLanguageCloneRequestVNext === undefined) {
            throw new RequiredError("MultiLanguageApi", "createLangVariation_2", "contentLanguageCloneRequestVNext");
        }
     ...
     * @param detachFromLangGroupRequestVNext 
     */
    public async detachFromLangGroup_3(detachFromLangGroupRequestVNext: DetachFromLangGroupRequestVNext, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'detachFromLangGroupRequestVNext' is not null or undefined
        if (detachFromLangGroupRequestVNext === null || detachFromLangGroupRequestVNext === undefined) {
            throw new RequiredError("MultiLanguageApi", "detachFromLangGroup_3", "detachFromLangGroupRequestVNext");
        }
     ...
     * @param updateLanguagesRequestVNext 
     */
    public async updateLangs_4(updateLanguagesRequestVNext: UpdateLanguagesRequestVNext, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'updateLanguagesRequestVNext' is not null or undefined
        if (updateLanguagesRequestVNext === null || updateLanguagesRequestVNext === undefined) {
            throw new RequiredError("MultiLanguageApi", "updateLangs_4", "updateLanguagesRequestVNext");
        }
...
export class MultiLanguageApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to attachToLangGroup_1
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async attachToLangGroup_1WithHttpInfo(response: ResponseContext): Promise<HttpInfo< void>> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("0", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createLangVariation_2
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createLangVariation_2WithHttpInfo(response: ResponseContext): Promise<HttpInfo<Page >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Page = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to detachFromLangGroup_3
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async detachFromLangGroup_3WithHttpInfo(response: ResponseContext): Promise<HttpInfo< void>> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("0", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateLangs_4
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateLangs_4WithHttpInfo(response: ResponseContext): Promise<HttpInfo< void>> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("0", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
