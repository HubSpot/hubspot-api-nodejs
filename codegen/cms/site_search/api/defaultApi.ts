...
export class DefaultApi {
     ...
     */
        public async getById (contentId: string, type?: 'LANDING_PAGE' | 'BLOG_POST' | 'SITE_PAGE' | 'DOCUMENT' | 'KNOWLEDGE_ARTICLE' | 'LISTING_PAGE', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IndexedData;  }> {
        ...
        if (type !== undefined) {
            localVarQueryParameters['type'] = ObjectSerializer.serialize(type, "'LANDING_PAGE' | 'BLOG_POST' | 'SITE_PAGE' | 'DOCUMENT' | 'KNOWLEDGE_ARTICLE' | 'LISTING_PAGE'");
        }
     ...
     */
        ...
        if (keyString !== undefined) {
            localVarQueryParameters['keyString'] = ObjectSerializer.serialize(keyString, "string");
        }
        ...
        if (type !== undefined) {
            localVarQueryParameters['type'] = ObjectSerializer.serialize(type, "Array<'LANDING_PAGE' | 'BLOG_POST' | 'SITE_PAGE' | 'DOCUMENT' | 'KNOWLEDGE_ARTICLE' | 'LISTING_PAGE'>");
        }
