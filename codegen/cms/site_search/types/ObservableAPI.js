...
var ObservableDefaultApi = (function () {
     ...
     */
    ObservableDefaultApi.prototype.getById = function (contentId, type, _options) {
        var _this = this;
        if (type === void 0) { type =  | 'BLOG_POST' | 'SITE_PAGE' | 'KNOWLEDGE_ARTICLE' | 'LISTING_PAGE'; }
        var requestContextPromise = this.requestFactory.getById(contentId, type, _options);
        // build promise chain
    ...
    ObservableDefaultApi.prototype.search = function (q, limit, offset, language, matchPrefix, autocomplete, popularityBoost, boostLimit, minScore, boostRecent, tableId, hubdbQuery, domain, type, pathPrefix, property, length, groupId, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map(function (rsp) { return _this.responseProcessor.search(rsp); }));
        }));
    };
