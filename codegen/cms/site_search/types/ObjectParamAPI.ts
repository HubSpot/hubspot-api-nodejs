...
export class ObjectPublicApi {
     ...
     */
    public getByIdWithHttpInfo(param: PublicApiGetByIdRequest, options?: ConfigurationOptions): Promise<HttpInfo<IndexedData>> {
     ...
     * @param param the request object
     */
    public getById(param: PublicApiGetByIdRequest, options?: ConfigurationOptions): Promise<IndexedData> {
     ...
     * @param param the request object
     */
    public searchWithHttpInfo(param: PublicApiSearchRequest = {}, options?: ConfigurationOptions): Promise<HttpInfo<PublicSearchResults>> {
     ...
     * @param param the request object
     */
    public search(param: PublicApiSearchRequest = {}, options?: ConfigurationOptions): Promise<PublicSearchResults> {
