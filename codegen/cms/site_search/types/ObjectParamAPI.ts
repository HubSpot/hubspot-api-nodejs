...
export class ObjectDefaultApi {
     ...
     */
    public getById(param: DefaultApiGetByIdRequest, options?: Configuration): Promise<IndexedData> {
     ...
     * @param param the request object
     */
    public search(param: DefaultApiSearchRequest, options?: Configuration): Promise<PublicSearchResults> {
