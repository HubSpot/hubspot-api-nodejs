...
let enumsMap: {[index: string]: any} = {
        "PublicAuditLog.EventEnum": PublicAuditLog.EventEnum,
        "PublicAuditLog.ObjectTypeEnum": PublicAuditLog.ObjectTypeEnum,
}

let typeMap: {[index: string]: any} = {
    "CollectionResponsePublicAuditLog": CollectionResponsePublicAuditLog,
