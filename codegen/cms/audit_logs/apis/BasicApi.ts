...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param userId 
     */
    public async cmsAuditLogsV3(after?: string, before?: string, eventType?: Array<string>, limit?: number, objectId?: Array<string>, objectType?: Array<string>, sort?: Array<string>, userId?: Array<string>, _options?: Configuration): Promise<RequestContext> {
...
export class BasicApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to cmsAuditLogsV3
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async cmsAuditLogsV3WithHttpInfo(response: ResponseContext): Promise<HttpInfo<CollectionResponsePublicAuditLog >> {
