...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param limit 
     */
    public async crmV3Owners(after?: string, archived?: boolean, email?: string, limit?: number, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param idProperty 
     */
    public async getById(ownerId: number, archived?: boolean, idProperty?: 'id' | 'userId', _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'ownerId' is not null or undefined
        if (ownerId === null || ownerId === undefined) {
            throw new RequiredError("BasicApi", "getById", "ownerId");
        }
...
export class BasicApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to crmV3Owners
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async crmV3OwnersWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CollectionResponsePublicOwnerForwardPaging >> {
