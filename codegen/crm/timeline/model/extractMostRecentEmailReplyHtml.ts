...
export class ExtractMostRecentEmailReplyHtml {
...
export namespace ExtractMostRecentEmailReplyHtml {
    export enum OperatorEnum {
        EXTRACTMOSTRECENTEMAILREPLYHTML = <any> 'EXTRACT_MOST_RECENT_EMAIL_REPLY_HTML'
    }
}
