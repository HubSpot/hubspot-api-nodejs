...
export class PipelineProbability {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "operator",
            "baseName": "operator",
            "type": "PipelineProbability.OperatorEnum"
        },
        {
            "name": "value",
            "baseName": "value",
    ...
    static getAttributeTypeMap() {
        return PipelineProbability.attributeTypeMap;
    }
}

export namespace PipelineProbability {
    export enum OperatorEnum {
        PIPELINEPROBABILITY = <any> 'PIPELINE_PROBABILITY'
    }
}
