...
export class HasEmailReply {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "operator",
            "baseName": "operator",
            "type": "HasEmailReply.OperatorEnum"
        },
        {
            "name": "value",
            "baseName": "value",
    ...
    static getAttributeTypeMap() {
        return HasEmailReply.attributeTypeMap;
    }
}

export namespace HasEmailReply {
    export enum OperatorEnum {
        HASEMAILREPLY = <any> 'HAS_EMAIL_REPLY'
    }
}
