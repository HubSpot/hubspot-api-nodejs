...
export class ExtractMostRecentEmailReplyText {
...
export namespace ExtractMostRecentEmailReplyText {
    export enum OperatorEnum {
        EXTRACTMOSTRECENTEMAILREPLYTEXT = <any> 'EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT'
    }
}
