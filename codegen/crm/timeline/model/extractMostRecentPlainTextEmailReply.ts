...
export class ExtractMostRecentPlainTextEmailReply {
...
export namespace ExtractMostRecentPlainTextEmailReply {
    export enum OperatorEnum {
        EXTRACTMOSTRECENTPLAINTEXTEMAILREPLY = <any> 'EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY'
    }
}
