...
var ObservableAssociationsApi = (function () {
     ...
     */
    ObservableAssociationsApi.prototype.archive = function (contactId, toObjectType, toObjectId, associationType, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.archive(contactId, toObjectType, toObjectId, associationType, _options);
        // build promise chain
     ...
     * @param associationType
     */
    ObservableAssociationsApi.prototype.create = function (contactId, toObjectType, toObjectId, associationType, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.create(contactId, toObjectType, toObjectId, associationType, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     */
    ObservableAssociationsApi.prototype.getAll = function (contactId, toObjectType, after, limit, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getAll(contactId, toObjectType, after, limit, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
...
var ObservableBasicApi = (function () {
     ...
     * @param contactId
     */
    ObservableBasicApi.prototype.archive = function (contactId, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.archive(contactId, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     */
    ObservableBasicApi.prototype.getById = function (contactId, properties, associations, archived, idProperty, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getById(contactId, properties, associations, archived, idProperty, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    ObservableBasicApi.prototype.update = function (contactId, simplePublicObjectInput, idProperty, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.update(contactId, simplePublicObjectInput, idProperty, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
