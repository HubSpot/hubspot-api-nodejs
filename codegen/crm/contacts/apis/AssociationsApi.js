...
var AssociationsApiRequestFactory = (function (_super) {
    ...
    function AssociationsApiRequestFactory() {
         ...
         */
        this.async = archive(contactId, string, toObjectType, string, toObjectId, string, associationType, string, _options ?  : Configuration);
        /**
         ...
         * @param associationType
         */
        this.async = create(contactId, string, toObjectType, string, toObjectId, string, associationType, string, _options ?  : Configuration);
        /**
         ...
         */
        this.async = getAll(contactId, string, toObjectType, string, after ?  : string, limit ?  : number, _options ?  : Configuration);
    }
    AssociationsApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/contacts/{contactId}/associations/{toObjectType}/{toObjectId}/{associationType}'
    ...
    AssociationsApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'contactId' is not null or undefined
        if (contactId === null || contactId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter contactId was null or undefined when calling create.');
        }
        // verify required parameter 'toObjectType' is not null or undefined
        if (toObjectType === null || toObjectType === undefined) {
    ...
    AssociationsApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'contactId' is not null or undefined
        if (contactId === null || contactId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter contactId was null or undefined when calling getAll.');
        }
        // verify required parameter 'toObjectType' is not null or undefined
        if (toObjectType === null || toObjectType === undefined) {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/contacts/{contactId}/associations/{toObjectType}'
            .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)))
            .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
        // Make Request Context
