...
export class GDPRApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async postCrmV3ObjectsContactsGdprDelete(publicGdprDeleteInput: PublicGdprDeleteInput, _options?: Configuration): Promise<RequestContext> {
        ...
        if (publicGdprDeleteInput === null || publicGdprDeleteInput === undefined) {
            throw new RequiredError("GDPRApi", "postCrmV3ObjectsContactsGdprDelete", "publicGdprDeleteInput");
        }
...
export class GDPRApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to postCrmV3ObjectsContactsGdprDelete
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async postCrmV3ObjectsContactsGdprDelete(response: ResponseContext): Promise<void > {
