...
export class AssociationsApi {
     ...
     * @param toObjectId 
     */
    public async archiveAssociation (contactId: string, associatedObjectType: string, toObjectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/crm/v3/objects/contacts/{contactId}/associations/{associatedObjectType}/{toObjectId}'
        ...
        if (contactId === null || contactId === undefined) {
            throw new Error('Required parameter contactId was null or undefined when calling archiveAssociation.');
        }
     ...
     * @param toObjectId 
     */
    public async createAssociation (contactId: string, associatedObjectType: string, toObjectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SimplePublicObject;  }> {
        const localVarPath = this.basePath + '/crm/v3/objects/contacts/{contactId}/associations/{associatedObjectType}/{toObjectId}'
            .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)))
            .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)))
            .replace('{' + 'toObjectId' + '}', encodeURIComponent(String(toObjectId)));
        ...
        // verify required parameter 'contactId' is not null or undefined
        if (contactId === null || contactId === undefined) {
            throw new Error('Required parameter contactId was null or undefined when calling createAssociation.');
        }
     ...
     * @param associatedObjectType 
     */
    public async getAssociations (contactId: string, associatedObjectType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CollectionResponseSimplePublicObjectId;  }> {
        const localVarPath = this.basePath + '/crm/v3/objects/contacts/{contactId}/associations/{associatedObjectType}'
            .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)))
            .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'contactId' is not null or undefined
        if (contactId === null || contactId === undefined) {
            throw new Error('Required parameter contactId was null or undefined when calling getAssociations.');
        }
