...
var ObservableCoreApi = (function () {
     ...
     */
    ObservableCoreApi.prototype.archive = function (objectType, archived, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.archive(objectType, archived, _options);
        // build promise chain
     ...
     */
    ObservableCoreApi.prototype.archiveAssociation = function (objectType, associationIdentifier, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.archiveAssociation(objectType, associationIdentifier, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map(function (rsp) { return _this.responseProcessor.archiveAssociation(rsp); }));
        }));
    };
    /**
     ...
     */
    ObservableCoreApi.prototype.create = function (objectSchemaEgg, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.create(objectSchemaEgg, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     */
    ObservableCoreApi.prototype.createAssociation = function (objectType, associationDefinitionEgg, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.createAssociation(objectType, associationDefinitionEgg, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map(function (rsp) { return _this.responseProcessor.createAssociation(rsp); }));
        }));
    };
    /**
     ...
     * @param archived Whether to return only results that have been archived.
     */
    ObservableCoreApi.prototype.getAll = function (archived, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getAll(archived, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     * @param objectType Fully qualified name or object type ID of your schema.
     */
    ObservableCoreApi.prototype.getById = function (objectType, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getById(objectType, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     */
    ObservableCoreApi.prototype.update = function (objectType, objectTypeDefinitionPatch, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.update(objectType, objectTypeDefinitionPatch, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
...
var ObservableDefaultApi = (function () {
     ...
     * @param objectType
     */
    ObservableDefaultApi.prototype.purge = function (objectType, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.purge(objectType, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map(function (rsp) { return _this.responseProcessor.purge(rsp); }));
        }));
    };
