...
var BasicApiRequestFactory = (function (_super) {
    ...
    function BasicApiRequestFactory() {
         ...
         * @param companyId
         */
        this.async = archive(companyId, string, _options ?  : Configuration);
        /**
         ...
         */
        this.async = getById(companyId, string, properties ?  : Array < string > , associations ?  : Array < string > , archived ?  : boolean, idProperty ?  : string, _options ?  : Configuration);
        /**
         ...
         * @param idProperty The name of a property whose values are unique for this object type
         */
        this.async = update(companyId, string, simplePublicObjectInput, SimplePublicObjectInput_1.SimplePublicObjectInput, idProperty ?  : string, _options ?  : Configuration);
    }
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/companies/{companyId}'
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/companies';
        // Make Request Context
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'companyId' is not null or undefined
        if (companyId === null || companyId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter companyId was null or undefined when calling getById.');
        }
        // Path Params
        var localVarPath = '/crm/v3/objects/companies/{companyId}'
            .replace('{' + 'companyId' + '}', encodeURIComponent(String(companyId)));
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'companyId' is not null or undefined
        if (companyId === null || companyId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter companyId was null or undefined when calling update.');
        }
        // verify required parameter 'simplePublicObjectInput' is not null or undefined
        if (simplePublicObjectInput === null || simplePublicObjectInput === undefined) {
