...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async archive(companyId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (companyId === null || companyId === undefined) {
            throw new RequiredError('Required parameter companyId was null or undefined when calling archive.');
        }
     ...
     */
    public async getById(companyId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'companyId' is not null or undefined
        if (companyId === null || companyId === undefined) {
            throw new RequiredError('Required parameter companyId was null or undefined when calling getById.');
        }
    ...
    public async update(companyId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'companyId' is not null or undefined
        if (companyId === null || companyId === undefined) {
            throw new RequiredError('Required parameter companyId was null or undefined when calling update.');
        }
