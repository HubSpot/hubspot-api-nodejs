...
var ObservableAssociationsApi = (function () {
     ...
     */
    ObservableAssociationsApi.prototype.archive = function (companyId, toObjectType, toObjectId, associationType, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.archive(companyId, toObjectType, toObjectId, associationType, _options);
        // build promise chain
     ...
     * @param associationType
     */
    ObservableAssociationsApi.prototype.create = function (companyId, toObjectType, toObjectId, associationType, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.create(companyId, toObjectType, toObjectId, associationType, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     */
    ObservableAssociationsApi.prototype.getAll = function (companyId, toObjectType, after, limit, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getAll(companyId, toObjectType, after, limit, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
...
var ObservableBasicApi = (function () {
     ...
     * @param companyId
     */
    ObservableBasicApi.prototype.archive = function (companyId, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.archive(companyId, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     */
    ObservableBasicApi.prototype.getById = function (companyId, properties, associations, archived, idProperty, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getById(companyId, properties, associations, archived, idProperty, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    ObservableBasicApi.prototype.update = function (companyId, simplePublicObjectInput, idProperty, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.update(companyId, simplePublicObjectInput, idProperty, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
