...
(function(root, factory) {
   ...
   * @class
   * @param createdAt {String} The date the pipeline stage was created. The stages on default pipelines will have createdAt = 0.
   * @param updatedAt {String} The date the pipeline stage was last updated.
   ...
   */
  var exports = function(createdAt, updatedAt, archived, label, displayOrder, metadata, id) {
    var _this = this;
