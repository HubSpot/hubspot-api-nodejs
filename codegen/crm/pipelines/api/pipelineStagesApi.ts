...
export class PipelineStagesApi {
     ...
     * @param stageId 
     */
    public archive (objectType: string, pipelineId: string, stageId: string) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/{objectType}/{pipelineId}/stages/{stageId}'
     ...
     */
    public create (objectType: string, pipelineId: string, pipelineStageInput?: PipelineStageInput) : Promise<{ response: http.IncomingMessage; body: PipelineStage;  }> {
     ...
     */
    public getById (objectType: string, pipelineId: string, stageId: string, archived?: boolean) : Promise<{ response: http.IncomingMessage; body: PipelineStage;  }> {
        const localVarPath = this.basePath + '/{objectType}/{pipelineId}/stages/{stageId}'
            .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
            .replace('{' + 'pipelineId' + '}', encodeURIComponent(String(pipelineId)))
            .replace('{' + 'stageId' + '}', encodeURIComponent(String(stageId)));
     ...
     * @param archived Whether to return only results that have been archived.
     */
    public getPage (objectType: string, pipelineId: string, archived?: boolean) : Promise<{ response: http.IncomingMessage; body: CollectionResponsePipelineStage;  }> {
        const localVarPath = this.basePath + '/{objectType}/{pipelineId}/stages'
            .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
            .replace('{' + 'pipelineId' + '}', encodeURIComponent(String(pipelineId)));
        let localVarQueryParameters: any = {};
     ...
     * @param pipelineStageInput 
     */
    public replace (objectType: string, pipelineId: string, stageId: string, pipelineStageInput?: PipelineStageInput) : Promise<{ response: http.IncomingMessage; body: PipelineStage;  }> {
        const localVarPath = this.basePath + '/{objectType}/{pipelineId}/stages/{stageId}'
            .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
            .replace('{' + 'pipelineId' + '}', encodeURIComponent(String(pipelineId)))
            .replace('{' + 'stageId' + '}', encodeURIComponent(String(stageId)));
     ...
     */
    public update (objectType: string, pipelineId: string, stageId: string, archived?: boolean, pipelineStagePatchInput?: PipelineStagePatchInput) : Promise<{ response: http.IncomingMessage; body: PipelineStage;  }> {
        const localVarPath = this.basePath + '/{objectType}/{pipelineId}/stages/{stageId}'
            .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
            .replace('{' + 'pipelineId' + '}', encodeURIComponent(String(pipelineId)))
            .replace('{' + 'stageId' + '}', encodeURIComponent(String(stageId)));
