...
export class PromiseAssociationsApi {
     ...
     */
    public getAll(feedbackSubmissionId: string, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<CollectionResponseAssociatedIdForwardPaging> {
        const result = this.api.getAll(feedbackSubmissionId, toObjectType, after, limit, _options);
...
export class PromiseBasicApi {
     ...
     */
    public getById(feedbackSubmissionId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<SimplePublicObjectWithAssociations> {
        const result = this.api.getById(feedbackSubmissionId, properties, associations, archived, idProperty, _options);
        return result.toPromise();
    }
