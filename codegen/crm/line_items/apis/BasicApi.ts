...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param lineItemId 
     */
    public async archive(lineItemId: string, _options?: Configuration): Promise<RequestContext> {
     ...
     */
    public async getById(lineItemId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'lineItemId' is not null or undefined
        if (lineItemId === null || lineItemId === undefined) {
            throw new RequiredError('Required parameter lineItemId was null or undefined when calling getById.');
        }
    ...
    public async update(lineItemId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'lineItemId' is not null or undefined
        if (lineItemId === null || lineItemId === undefined) {
            throw new RequiredError('Required parameter lineItemId was null or undefined when calling update.');
        }
