...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param lineItemId 
     */
    public async deleteCrmV3ObjectsLineItemsLineItemId(lineItemId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'lineItemId' is not null or undefined
        if (lineItemId === null || lineItemId === undefined) {
            throw new RequiredError("BasicApi", "deleteCrmV3ObjectsLineItemsLineItemId", "lineItemId");
        }


        // Path Params
        const localVarPath = '/crm/v3/objects/line items/{lineItemId}'
     ...
     */
    public async getCrmV3ObjectsLineItems(limit?: number, after?: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // Path Params
        const localVarPath = '/crm/v3/objects/line items';
     ...
     */
    public async getCrmV3ObjectsLineItemsLineItemId(lineItemId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'lineItemId' is not null or undefined
        if (lineItemId === null || lineItemId === undefined) {
            throw new RequiredError("BasicApi", "getCrmV3ObjectsLineItemsLineItemId", "lineItemId");
        }
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public async patchCrmV3ObjectsLineItemsLineItemId(lineItemId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'lineItemId' is not null or undefined
        if (lineItemId === null || lineItemId === undefined) {
            throw new RequiredError("BasicApi", "patchCrmV3ObjectsLineItemsLineItemId", "lineItemId");
        }
        ...
        if (simplePublicObjectInput === null || simplePublicObjectInput === undefined) {
            throw new RequiredError("BasicApi", "patchCrmV3ObjectsLineItemsLineItemId", "simplePublicObjectInput");
        }
     ...
     */
    public async postCrmV3ObjectsLineItems(simplePublicObjectInputForCreate: SimplePublicObjectInputForCreate, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (simplePublicObjectInputForCreate === null || simplePublicObjectInputForCreate === undefined) {
            throw new RequiredError("BasicApi", "postCrmV3ObjectsLineItems", "simplePublicObjectInputForCreate");
        }
...
export class BasicApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to deleteCrmV3ObjectsLineItemsLineItemId
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteCrmV3ObjectsLineItemsLineItemId(response: ResponseContext): Promise<void > {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getCrmV3ObjectsLineItems
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getCrmV3ObjectsLineItems(response: ResponseContext): Promise<CollectionResponseSimplePublicObjectWithAssociationsForwardPaging > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getCrmV3ObjectsLineItemsLineItemId
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getCrmV3ObjectsLineItemsLineItemId(response: ResponseContext): Promise<SimplePublicObjectWithAssociations > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to patchCrmV3ObjectsLineItemsLineItemId
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchCrmV3ObjectsLineItemsLineItemId(response: ResponseContext): Promise<SimplePublicObject > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to postCrmV3ObjectsLineItems
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async postCrmV3ObjectsLineItems(response: ResponseContext): Promise<SimplePublicObject > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
