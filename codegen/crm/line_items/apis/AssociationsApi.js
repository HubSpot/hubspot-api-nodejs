...
var AssociationsApiRequestFactory = (function (_super) {
    ...
    function AssociationsApiRequestFactory() {
         ...
         */
        this.async = archive(lineItemId, string, toObjectType, string, toObjectId, string, associationType, string, _options ?  : Configuration);
        /**
         ...
         * @param associationType
         */
        this.async = create(lineItemId, string, toObjectType, string, toObjectId, string, associationType, string, _options ?  : Configuration);
        /**
         ...
         */
        this.async = getAll(lineItemId, string, toObjectType, string, after ?  : string, limit ?  : number, _options ?  : Configuration);
    }
    AssociationsApiRequestFactory.prototype.Promise = function () {
        ...
        if (lineItemId === null || lineItemId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter lineItemId was null or undefined when calling archive.');
        }
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/line_items/{lineItemId}/associations/{toObjectType}/{toObjectId}/{associationType}'
    ...
    AssociationsApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'lineItemId' is not null or undefined
        if (lineItemId === null || lineItemId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter lineItemId was null or undefined when calling create.');
        }
        // verify required parameter 'toObjectType' is not null or undefined
        if (toObjectType === null || toObjectType === undefined) {
    ...
    AssociationsApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'lineItemId' is not null or undefined
        if (lineItemId === null || lineItemId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter lineItemId was null or undefined when calling getAll.');
        }
        // verify required parameter 'toObjectType' is not null or undefined
        if (toObjectType === null || toObjectType === undefined) {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/line_items/{lineItemId}/associations/{toObjectType}'
            .replace('{' + 'lineItemId' + '}', encodeURIComponent(String(lineItemId)))
            .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
        // Make Request Context
