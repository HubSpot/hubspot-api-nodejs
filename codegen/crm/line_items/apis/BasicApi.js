...
var BasicApiRequestFactory = (function (_super) {
    ...
    function BasicApiRequestFactory() {
         ...
         * @param lineItemId
         */
        this.async = archive(lineItemId, string, _options ?  : Configuration);
        /**
         ...
         */
        this.async = getById(lineItemId, string, properties ?  : Array < string > , associations ?  : Array < string > , archived ?  : boolean, idProperty ?  : string, _options ?  : Configuration);
        /**
         ...
         * @param idProperty The name of a property whose values are unique for this object type
         */
        this.async = update(lineItemId, string, simplePublicObjectInput, SimplePublicObjectInput_1.SimplePublicObjectInput, idProperty ?  : string, _options ?  : Configuration);
    }
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/line_items/{lineItemId}'
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/line_items';
        // Make Request Context
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'lineItemId' is not null or undefined
        if (lineItemId === null || lineItemId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter lineItemId was null or undefined when calling getById.');
        }
        // Path Params
        var localVarPath = '/crm/v3/objects/line_items/{lineItemId}'
            .replace('{' + 'lineItemId' + '}', encodeURIComponent(String(lineItemId)));
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'lineItemId' is not null or undefined
        if (lineItemId === null || lineItemId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter lineItemId was null or undefined when calling update.');
        }
        // verify required parameter 'simplePublicObjectInput' is not null or undefined
        if (simplePublicObjectInput === null || simplePublicObjectInput === undefined) {
