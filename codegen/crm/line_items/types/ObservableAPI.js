...
var ObservableAssociationsApi = (function () {
     ...
     */
    ObservableAssociationsApi.prototype.archive = function (lineItemId, toObjectType, toObjectId, associationType, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.archive(lineItemId, toObjectType, toObjectId, associationType, _options);
        // build promise chain
     ...
     * @param associationType
     */
    ObservableAssociationsApi.prototype.create = function (lineItemId, toObjectType, toObjectId, associationType, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.create(lineItemId, toObjectType, toObjectId, associationType, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     */
    ObservableAssociationsApi.prototype.getAll = function (lineItemId, toObjectType, after, limit, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getAll(lineItemId, toObjectType, after, limit, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
...
var ObservableBasicApi = (function () {
     ...
     * @param lineItemId
     */
    ObservableBasicApi.prototype.archive = function (lineItemId, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.archive(lineItemId, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     */
    ObservableBasicApi.prototype.create = function (simplePublicObjectInput, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.create(simplePublicObjectInput, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     */
    ObservableBasicApi.prototype.getById = function (lineItemId, properties, associations, archived, idProperty, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getById(lineItemId, properties, associations, archived, idProperty, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     * @param archived Whether to return only results that have been archived.
     */
    ObservableBasicApi.prototype.getPage = function (limit, after, properties, associations, archived, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getPage(limit, after, properties, associations, archived, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    ObservableBasicApi.prototype.update = function (lineItemId, simplePublicObjectInput, idProperty, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.update(lineItemId, simplePublicObjectInput, idProperty, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
...
var ObservableBatchApi = (function () {
     ...
     */
    ObservableBatchApi.prototype.archive = function (batchInputSimplePublicObjectId, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.archive(batchInputSimplePublicObjectId, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     */
    ObservableBatchApi.prototype.create = function (batchInputSimplePublicObjectInput, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.create(batchInputSimplePublicObjectInput, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     * @param archived Whether to return only results that have been archived.
     */
    ObservableBatchApi.prototype.read = function (batchReadInputSimplePublicObjectId, archived, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.read(batchReadInputSimplePublicObjectId, archived, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     */
    ObservableBatchApi.prototype.update = function (batchInputSimplePublicObjectBatchInput, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.update(batchInputSimplePublicObjectBatchInput, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
...
var ObservableSearchApi = (function () {
     ...
     */
    ObservableSearchApi.prototype.doSearch = function (publicObjectSearchRequest, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.doSearch(publicObjectSearchRequest, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
