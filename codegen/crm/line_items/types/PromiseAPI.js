...
var PromiseAssociationsApi = (function () {
     ...
     */
    PromiseAssociationsApi.prototype.archive = function (lineItemId, toObjectType, toObjectId, associationType, _options) {
        var result = this.api.archive(lineItemId, toObjectType, toObjectId, associationType, _options);
     ...
     * @param associationType
     */
    PromiseAssociationsApi.prototype.create = function (lineItemId, toObjectType, toObjectId, associationType, _options) {
        var result = this.api.create(lineItemId, toObjectType, toObjectId, associationType, _options);
        return result.toPromise();
    };
    /**
     ...
     */
    PromiseAssociationsApi.prototype.getAll = function (lineItemId, toObjectType, after, limit, _options) {
        var result = this.api.getAll(lineItemId, toObjectType, after, limit, _options);
        return result.toPromise();
    };
...
var PromiseBasicApi = (function () {
     ...
     * @param lineItemId
     */
    PromiseBasicApi.prototype.archive = function (lineItemId, _options) {
        var result = this.api.archive(lineItemId, _options);
        return result.toPromise();
    };
    /**
     ...
     */
    PromiseBasicApi.prototype.getById = function (lineItemId, properties, associations, archived, idProperty, _options) {
        var result = this.api.getById(lineItemId, properties, associations, archived, idProperty, _options);
        return result.toPromise();
    };
    /**
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    PromiseBasicApi.prototype.update = function (lineItemId, simplePublicObjectInput, idProperty, _options) {
        var result = this.api.update(lineItemId, simplePublicObjectInput, idProperty, _options);
        return result.toPromise();
    };
