...
export class AssociationsApi {
    ...
    public async archiveAssociation (lineItemId: string, associatedObjectType: string, toObjectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/line_items/{lineItemId}/associations/{associatedObjectType}/{toObjectId}'
    ...
    public async getAssociations (lineItemId: string, associatedObjectType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CollectionResponseSimplePublicObjectId;  }> {
        const localVarPath = this.basePath + '/line_items/{lineItemId}/associations/{associatedObjectType}'
            .replace('{' + 'lineItemId' + '}', encodeURIComponent(String(lineItemId)))
            .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
