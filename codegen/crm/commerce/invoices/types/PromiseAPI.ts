...
export class PromiseBasicApi {
     ...
     */
    public getByIdWithHttpInfo(invoiceId: string, archived?: boolean, associations?: Array<string>, idProperty?: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, _options?: PromiseConfigurationOptions): Promise<HttpInfo<SimplePublicObjectWithAssociations>> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.getByIdWithHttpInfo(invoiceId, archived, associations, idProperty, properties, propertiesWithHistory, observableOptions);
        return result.toPromise();
    }
     ...
     * @param [propertiesWithHistory] A comma separated list of the properties to be returned along with their history of previous values. If any of the specified properties are not present on the requested object(s), they will be ignored.
     */
    public getById(invoiceId: string, archived?: boolean, associations?: Array<string>, idProperty?: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, _options?: PromiseConfigurationOptions): Promise<SimplePublicObjectWithAssociations> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.getById(invoiceId, archived, associations, idProperty, properties, propertiesWithHistory, observableOptions);
        return result.toPromise();
    }
