...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param invoiceId 
     */
    public async archive(invoiceId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'invoiceId' is not null or undefined
        if (invoiceId === null || invoiceId === undefined) {
            throw new RequiredError("BasicApi", "archive", "invoiceId");
        }


        // Path Params
        const localVarPath = '/crm/v3/objects/invoices/{invoiceId}'
    ...
    public async create(simplePublicObjectInputForCreate: SimplePublicObjectInputForCreate, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/crm/v3/objects/invoices';
     ...
     */
    public async getById(invoiceId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'invoiceId' is not null or undefined
        if (invoiceId === null || invoiceId === undefined) {
            throw new RequiredError("BasicApi", "getById", "invoiceId");
        }
     ...
     * @param idProperty The name of a property whose values are unique for this object
     */
    public async update(invoiceId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'invoiceId' is not null or undefined
        if (invoiceId === null || invoiceId === undefined) {
            throw new RequiredError("BasicApi", "update", "invoiceId");
        }
