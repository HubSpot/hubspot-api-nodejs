...
export class ObservableAssociationsApi {
     ...
     */
    public archive(productId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<void> {
     ...
     * @param associationType 
     */
    public create(productId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations> {
     ...
     */
    public getAll(productId: string, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Observable<CollectionResponseAssociatedIdForwardPaging> {
...
export class ObservableBasicApi {
     ...
     */
    public getById(productId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations> {
        const requestContextPromise = this.requestFactory.getById(productId, properties, associations, archived, idProperty, _options);
