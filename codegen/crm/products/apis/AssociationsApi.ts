...
export class AssociationsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async archive(productId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (productId === null || productId === undefined) {
            throw new RequiredError("AssociationsApi", "archive", "productId");
        }
    ...
    public async create(productId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'productId' is not null or undefined
        if (productId === null || productId === undefined) {
            throw new RequiredError("AssociationsApi", "create", "productId");
        }
    ...
    public async getAll(productId: string, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'productId' is not null or undefined
        if (productId === null || productId === undefined) {
            throw new RequiredError("AssociationsApi", "getAll", "productId");
        }
