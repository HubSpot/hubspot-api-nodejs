...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async archive(productId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (productId === null || productId === undefined) {
            throw new RequiredError("BasicApi", "archive", "productId");
        }
     ...
     */
    public async getById(productId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'productId' is not null or undefined
        if (productId === null || productId === undefined) {
            throw new RequiredError("BasicApi", "getById", "productId");
        }
    ...
    public async update(productId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'productId' is not null or undefined
        if (productId === null || productId === undefined) {
            throw new RequiredError("BasicApi", "update", "productId");
        }
