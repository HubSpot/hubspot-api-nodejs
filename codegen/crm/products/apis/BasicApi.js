...
var BasicApiRequestFactory = (function (_super) {
    ...
    function BasicApiRequestFactory() {
         ...
         * @param productId
         */
        this.async = archive(productId, string, _options ?  : Configuration);
        /**
         ...
         */
        this.async = getById(productId, string, properties ?  : Array < string > , associations ?  : Array < string > , archived ?  : boolean, idProperty ?  : string, _options ?  : Configuration);
        /**
         ...
         * @param idProperty The name of a property whose values are unique for this object type
         */
        this.async = update(productId, string, simplePublicObjectInput, SimplePublicObjectInput_1.SimplePublicObjectInput, idProperty ?  : string, _options ?  : Configuration);
    }
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/products/{productId}'
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/products';
        // Make Request Context
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'productId' is not null or undefined
        if (productId === null || productId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter productId was null or undefined when calling getById.');
        }
        // Path Params
        var localVarPath = '/crm/v3/objects/products/{productId}'
            .replace('{' + 'productId' + '}', encodeURIComponent(String(productId)));
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'productId' is not null or undefined
        if (productId === null || productId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter productId was null or undefined when calling update.');
        }
        // verify required parameter 'simplePublicObjectInput' is not null or undefined
        if (simplePublicObjectInput === null || simplePublicObjectInput === undefined) {
