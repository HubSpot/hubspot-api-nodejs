...
var AssociationsApiRequestFactory = (function (_super) {
    ...
    function AssociationsApiRequestFactory() {
         ...
         */
        this.async = archive(ticketId, string, toObjectType, string, toObjectId, string, associationType, string, _options ?  : Configuration);
        /**
         ...
         * @param associationType
         */
        this.async = create(ticketId, string, toObjectType, string, toObjectId, string, associationType, string, _options ?  : Configuration);
        /**
         ...
         */
        this.async = getAll(ticketId, string, toObjectType, string, after ?  : string, limit ?  : number, _options ?  : Configuration);
    }
    AssociationsApiRequestFactory.prototype.Promise = function () {
        var _config = _options || this.configuration;
        // verify required parameter 'ticketId' is not null or undefined
        if (ticketId === null || ticketId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter ticketId was null or undefined when calling archive.');
        }
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/tickets/{ticketId}/associations/{toObjectType}/{toObjectId}/{associationType}'
    ...
    AssociationsApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'ticketId' is not null or undefined
        if (ticketId === null || ticketId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter ticketId was null or undefined when calling create.');
        }
        // verify required parameter 'toObjectType' is not null or undefined
        if (toObjectType === null || toObjectType === undefined) {
    ...
    AssociationsApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'ticketId' is not null or undefined
        if (ticketId === null || ticketId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter ticketId was null or undefined when calling getAll.');
        }
        // verify required parameter 'toObjectType' is not null or undefined
        if (toObjectType === null || toObjectType === undefined) {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/tickets/{ticketId}/associations/{toObjectType}'
            .replace('{' + 'ticketId' + '}', encodeURIComponent(String(ticketId)))
            .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
        // Make Request Context
