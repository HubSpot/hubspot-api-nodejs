...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async archive(ticketId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (ticketId === null || ticketId === undefined) {
            throw new RequiredError('Required parameter ticketId was null or undefined when calling archive.');
        }
     ...
     */
    public async getById(ticketId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'ticketId' is not null or undefined
        if (ticketId === null || ticketId === undefined) {
            throw new RequiredError('Required parameter ticketId was null or undefined when calling getById.');
        }
    ...
    public async update(ticketId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'ticketId' is not null or undefined
        if (ticketId === null || ticketId === undefined) {
            throw new RequiredError('Required parameter ticketId was null or undefined when calling update.');
        }
