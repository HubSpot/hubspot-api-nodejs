...
var BasicApiRequestFactory = (function (_super) {
    ...
    function BasicApiRequestFactory() {
         ...
         * @param ticketId
         */
        this.async = archive(ticketId, string, _options ?  : Configuration);
        /**
         ...
         */
        this.async = getById(ticketId, string, properties ?  : Array < string > , associations ?  : Array < string > , archived ?  : boolean, idProperty ?  : string, _options ?  : Configuration);
        /**
         ...
         * @param idProperty The name of a property whose values are unique for this object type
         */
        this.async = update(ticketId, string, simplePublicObjectInput, SimplePublicObjectInput_1.SimplePublicObjectInput, idProperty ?  : string, _options ?  : Configuration);
    }
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/tickets/{ticketId}'
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/tickets';
        // Make Request Context
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'ticketId' is not null or undefined
        if (ticketId === null || ticketId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter ticketId was null or undefined when calling getById.');
        }
        // Path Params
        var localVarPath = '/crm/v3/objects/tickets/{ticketId}'
            .replace('{' + 'ticketId' + '}', encodeURIComponent(String(ticketId)));
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'ticketId' is not null or undefined
        if (ticketId === null || ticketId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter ticketId was null or undefined when calling update.');
        }
        // verify required parameter 'simplePublicObjectInput' is not null or undefined
        if (simplePublicObjectInput === null || simplePublicObjectInput === undefined) {
