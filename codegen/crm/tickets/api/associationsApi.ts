...
export class AssociationsApi {
     ...
     * @param toObjectId 
     */
    public async archiveAssociation (ticketId: string, associatedObjectType: string, toObjectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/crm/v3/objects/tickets/{ticketId}/associations/{associatedObjectType}/{toObjectId}'
        ...
        if (ticketId === null || ticketId === undefined) {
            throw new Error('Required parameter ticketId was null or undefined when calling archiveAssociation.');
        }
     ...
     * @param toObjectId 
     */
    public async createAssociation (ticketId: string, associatedObjectType: string, toObjectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SimplePublicObject;  }> {
        const localVarPath = this.basePath + '/crm/v3/objects/tickets/{ticketId}/associations/{associatedObjectType}/{toObjectId}'
            .replace('{' + 'ticketId' + '}', encodeURIComponent(String(ticketId)))
            .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)))
            .replace('{' + 'toObjectId' + '}', encodeURIComponent(String(toObjectId)));
        ...
        // verify required parameter 'ticketId' is not null or undefined
        if (ticketId === null || ticketId === undefined) {
            throw new Error('Required parameter ticketId was null or undefined when calling createAssociation.');
        }
     ...
     * @param associatedObjectType 
     */
    public async getAssociations (ticketId: string, associatedObjectType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CollectionResponseSimplePublicObjectId;  }> {
        const localVarPath = this.basePath + '/crm/v3/objects/tickets/{ticketId}/associations/{associatedObjectType}'
            .replace('{' + 'ticketId' + '}', encodeURIComponent(String(ticketId)))
            .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'ticketId' is not null or undefined
        if (ticketId === null || ticketId === undefined) {
            throw new Error('Required parameter ticketId was null or undefined when calling getAssociations.');
        }
