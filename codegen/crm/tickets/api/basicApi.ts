...
export class BasicApi {
     ...
     */
    public async getById (ticketId: string, properties?: Array<string>, associations?: Array<string>, paginateAssociations?: boolean, archived?: boolean, idProperty?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SimplePublicObject;  }> {
        const localVarPath = this.basePath + '/crm/v3/objects/tickets/{ticketId}'
            .replace('{' + 'ticketId' + '}', encodeURIComponent(String(ticketId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
