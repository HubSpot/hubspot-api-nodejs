...
var ObservableAssociationsApi = (function () {
     ...
     */
    ObservableAssociationsApi.prototype.archive = function (ticketId, toObjectType, toObjectId, associationType, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.archive(ticketId, toObjectType, toObjectId, associationType, _options);
        // build promise chain
     ...
     * @param associationType
     */
    ObservableAssociationsApi.prototype.create = function (ticketId, toObjectType, toObjectId, associationType, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.create(ticketId, toObjectType, toObjectId, associationType, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     */
    ObservableAssociationsApi.prototype.getAll = function (ticketId, toObjectType, after, limit, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getAll(ticketId, toObjectType, after, limit, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
...
var ObservableBasicApi = (function () {
     ...
     * @param ticketId
     */
    ObservableBasicApi.prototype.archive = function (ticketId, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.archive(ticketId, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     */
    ObservableBasicApi.prototype.getById = function (ticketId, properties, associations, archived, idProperty, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getById(ticketId, properties, associations, archived, idProperty, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    ObservableBasicApi.prototype.update = function (ticketId, simplePublicObjectInput, idProperty, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.update(ticketId, simplePublicObjectInput, idProperty, _options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (var _i = 0, _a = this.configuration.middleware; _i < _a.length; _i++) {
            var middleware = _a[_i];
