...
var PromiseAssociationsApi = (function () {
     ...
     */
    PromiseAssociationsApi.prototype.archive = function (ticketId, toObjectType, toObjectId, associationType, _options) {
        var result = this.api.archive(ticketId, toObjectType, toObjectId, associationType, _options);
     ...
     * @param associationType
     */
    PromiseAssociationsApi.prototype.create = function (ticketId, toObjectType, toObjectId, associationType, _options) {
        var result = this.api.create(ticketId, toObjectType, toObjectId, associationType, _options);
        return result.toPromise();
    };
    /**
     ...
     */
    PromiseAssociationsApi.prototype.getAll = function (ticketId, toObjectType, after, limit, _options) {
        var result = this.api.getAll(ticketId, toObjectType, after, limit, _options);
        return result.toPromise();
    };
...
var PromiseBasicApi = (function () {
     ...
     * @param ticketId
     */
    PromiseBasicApi.prototype.archive = function (ticketId, _options) {
        var result = this.api.archive(ticketId, _options);
        return result.toPromise();
    };
    /**
     ...
     */
    PromiseBasicApi.prototype.getById = function (ticketId, properties, associations, archived, idProperty, _options) {
        var result = this.api.getById(ticketId, properties, associations, archived, idProperty, _options);
        return result.toPromise();
    };
    /**
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    PromiseBasicApi.prototype.update = function (ticketId, simplePublicObjectInput, idProperty, _options) {
        var result = this.api.update(ticketId, simplePublicObjectInput, idProperty, _options);
        return result.toPromise();
    };
