...
export class AssociationsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async archive(dealId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param associationType 
     */
    public async create(dealId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'dealId' is not null or undefined
        if (dealId === null || dealId === undefined) {
            throw new RequiredError('Required parameter dealId was null or undefined when calling create.');
        }
     ...
     */
    public async getAll(dealId: string, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'dealId' is not null or undefined
        if (dealId === null || dealId === undefined) {
            throw new RequiredError('Required parameter dealId was null or undefined when calling getAll.');
        }
