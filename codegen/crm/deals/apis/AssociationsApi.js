...
var AssociationsApiRequestFactory = (function (_super) {
    ...
    function AssociationsApiRequestFactory() {
         ...
         */
        this.async = archive(dealId, string, toObjectType, string, toObjectId, string, associationType, string, _options ?  : Configuration);
        /**
         ...
         * @param associationType
         */
        this.async = create(dealId, string, toObjectType, string, toObjectId, string, associationType, string, _options ?  : Configuration);
        /**
         ...
         */
        this.async = getAll(dealId, string, toObjectType, string, after ?  : string, limit ?  : number, _options ?  : Configuration);
    }
    AssociationsApiRequestFactory.prototype.Promise = function () {
        ...
        if (dealId === null || dealId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter dealId was null or undefined when calling archive.');
        }
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/deals/{dealId}/associations/{toObjectType}/{toObjectId}/{associationType}'
    ...
    AssociationsApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'dealId' is not null or undefined
        if (dealId === null || dealId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter dealId was null or undefined when calling create.');
        }
        // verify required parameter 'toObjectType' is not null or undefined
        if (toObjectType === null || toObjectType === undefined) {
    ...
    AssociationsApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'dealId' is not null or undefined
        if (dealId === null || dealId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter dealId was null or undefined when calling getAll.');
        }
        // verify required parameter 'toObjectType' is not null or undefined
        if (toObjectType === null || toObjectType === undefined) {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/deals/{dealId}/associations/{toObjectType}'
            .replace('{' + 'dealId' + '}', encodeURIComponent(String(dealId)))
            .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
        // Make Request Context
