...
var BasicApiRequestFactory = (function (_super) {
    ...
    function BasicApiRequestFactory() {
         ...
         * @param dealId
         */
        this.async = archive(dealId, string, _options ?  : Configuration);
        /**
         ...
         */
        this.async = getById(dealId, string, properties ?  : Array < string > , associations ?  : Array < string > , archived ?  : boolean, idProperty ?  : string, _options ?  : Configuration);
        /**
         ...
         * @param idProperty The name of a property whose values are unique for this object type
         */
        this.async = update(dealId, string, simplePublicObjectInput, SimplePublicObjectInput_1.SimplePublicObjectInput, idProperty ?  : string, _options ?  : Configuration);
    }
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/deals/{dealId}'
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/deals';
        // Make Request Context
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'dealId' is not null or undefined
        if (dealId === null || dealId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter dealId was null or undefined when calling getById.');
        }
        // Path Params
        var localVarPath = '/crm/v3/objects/deals/{dealId}'
            .replace('{' + 'dealId' + '}', encodeURIComponent(String(dealId)));
    ...
    BasicApiRequestFactory.prototype.Promise = function () {
        ...
        // verify required parameter 'dealId' is not null or undefined
        if (dealId === null || dealId === undefined) {
            throw new baseapi_1.RequiredError('Required parameter dealId was null or undefined when calling update.');
        }
        // verify required parameter 'simplePublicObjectInput' is not null or undefined
        if (simplePublicObjectInput === null || simplePublicObjectInput === undefined) {
