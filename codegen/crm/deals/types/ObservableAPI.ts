...
export class ObservableAssociationsApi {
     ...
     * @param toObjectId 
     */
    public archive(dealId: number, toObjectType: string, toObjectId: number, _options?: Configuration): Observable<void> {
     ...
     */
    public create(dealId: number, toObjectType: string, toObjectId: number, associationSpec: Array<AssociationSpec>, _options?: Configuration): Observable<LabelsBetweenObjectPair> {
     ...
     */
    public getAll(dealId: number, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Observable<CollectionResponseMultiAssociatedObjectWithLabelForwardPaging> {
