...
export class BasicApi {
    ...
    public async archive (dealId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/deals/{dealId}'
    ...
    /**
     * Read an Object identified by `{dealId}`. Control what is returned via the `properties` query param.
     * @summary Read
     * @param dealId 
     ...
     */
    public async getById (dealId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SimplePublicObject;  }> {
        const localVarPath = this.basePath + '/deals/{dealId}'
            .replace('{' + 'dealId' + '}', encodeURIComponent(String(dealId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
