...
export class AssociationsApi {
     ...
     * @param toObjectId 
     */
    public async archiveAssociation (dealId: string, associatedObjectType: string, toObjectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/crm/v3/objects/deals/{dealId}/associations/{associatedObjectType}/{toObjectId}'
        ...
        if (dealId === null || dealId === undefined) {
            throw new Error('Required parameter dealId was null or undefined when calling archiveAssociation.');
        }
     ...
     * @param toObjectId 
     */
    public async createAssociation (dealId: string, associatedObjectType: string, toObjectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SimplePublicObject;  }> {
        const localVarPath = this.basePath + '/crm/v3/objects/deals/{dealId}/associations/{associatedObjectType}/{toObjectId}'
            .replace('{' + 'dealId' + '}', encodeURIComponent(String(dealId)))
            .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)))
            .replace('{' + 'toObjectId' + '}', encodeURIComponent(String(toObjectId)));
        ...
        // verify required parameter 'dealId' is not null or undefined
        if (dealId === null || dealId === undefined) {
            throw new Error('Required parameter dealId was null or undefined when calling createAssociation.');
        }
     ...
     * @param associatedObjectType 
     */
    public async getAssociations (dealId: string, associatedObjectType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CollectionResponseSimplePublicObjectId;  }> {
        const localVarPath = this.basePath + '/crm/v3/objects/deals/{dealId}/associations/{associatedObjectType}'
            .replace('{' + 'dealId' + '}', encodeURIComponent(String(dealId)))
            .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'dealId' is not null or undefined
        if (dealId === null || dealId === undefined) {
            throw new Error('Required parameter dealId was null or undefined when calling getAssociations.');
        }
