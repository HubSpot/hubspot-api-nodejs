...
export class PromiseDefinitionsApi {
     ...
     */
    public removeWithHttpInfo(fromObjectType: string, toObjectType: string, associationTypeId: number, _options?: Configuration): Promise<HttpInfo<void>> {
        const result = this.api.removeWithHttpInfo(fromObjectType, toObjectType, associationTypeId, _options);
        return result.toPromise();
    }
     ...
     * @param associationTypeId 
     */
    public remove(fromObjectType: string, toObjectType: string, associationTypeId: number, _options?: Configuration): Promise<void> {
        const result = this.api.remove(fromObjectType, toObjectType, associationTypeId, _options);
        return result.toPromise();
    }
