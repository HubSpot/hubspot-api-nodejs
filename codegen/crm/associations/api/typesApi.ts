...
import { CollectionResponsePublicAssociationDefiniton } from '../model/collectionResponsePublicAssociationDefiniton';
...
export class TypesApi {
    ...
    public async getTypes (fromObjectType: string, toObjectType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CollectionResponsePublicAssociationDefiniton;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CollectionResponsePublicAssociationDefiniton;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CollectionResponsePublicAssociationDefiniton");
