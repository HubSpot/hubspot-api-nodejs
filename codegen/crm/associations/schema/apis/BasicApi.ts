...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async getAll(fromObjectType: string, toObjectType: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (fromObjectType === null || fromObjectType === undefined) {
            throw new RequiredError("BasicApi", "getAll", "fromObjectType");
        }


        // verify required parameter 'toObjectType' is not null or undefined
        if (toObjectType === null || toObjectType === undefined) {
            throw new RequiredError("BasicApi", "getAll", "toObjectType");
        }
...
export class BasicApiResponseProcessor {
     ...
     */
     public async getAllWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CollectionResponsePublicAssociationDefinitionNoPaging >> {
