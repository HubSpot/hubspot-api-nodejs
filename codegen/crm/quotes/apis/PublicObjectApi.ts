...
export class PublicObjectApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async postCrmV3ObjectsQuotesMerge(publicMergeInput: PublicMergeInput, _options?: Configuration): Promise<RequestContext> {
        ...
        if (publicMergeInput === null || publicMergeInput === undefined) {
            throw new RequiredError("PublicObjectApi", "postCrmV3ObjectsQuotesMerge", "publicMergeInput");
        }
...
export class PublicObjectApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to postCrmV3ObjectsQuotesMerge
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async postCrmV3ObjectsQuotesMerge(response: ResponseContext): Promise<SimplePublicObject > {
