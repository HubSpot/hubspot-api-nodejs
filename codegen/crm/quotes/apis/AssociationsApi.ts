...
export class AssociationsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async archive(quoteId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param associationType 
     */
    public async create(quoteId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
