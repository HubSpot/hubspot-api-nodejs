...
export class ObservableBasicApi {
     ...
     */
    public getById(quoteId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations> {
        const requestContextPromise = this.requestFactory.getById(quoteId, properties, associations, archived, idProperty, _options);
