...
export class PromisePublicObjectApi {
     ...
     */
    public postCrmV3ObjectsQuotesMerge(publicMergeInput: PublicMergeInput, _options?: Configuration): Promise<SimplePublicObject> {
        const result = this.api.postCrmV3ObjectsQuotesMerge(publicMergeInput, _options);
        return result.toPromise();
    }
