...
export interface PublicObjectApiPostCrmV3ObjectsQuotesMergeRequest {
    /**
     * 
     * @type PublicMergeInput
     * @memberof PublicObjectApipostCrmV3ObjectsQuotesMerge
     */
...
export class ObjectPublicObjectApi {
     ...
     * @param param the request object
     */
    public postCrmV3ObjectsQuotesMerge(param: PublicObjectApiPostCrmV3ObjectsQuotesMergeRequest, options?: Configuration): Promise<SimplePublicObject> {
        return this.api.postCrmV3ObjectsQuotesMerge(param.publicMergeInput,  options).toPromise();
    }
