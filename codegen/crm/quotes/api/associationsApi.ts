...
export class AssociationsApi {
    ...
    public async archiveAssociation (quoteId: string, associatedObjectType: string, toObjectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/quotes/{quoteId}/associations/{associatedObjectType}/{toObjectId}'
    ...
    public async getAssociations (quoteId: string, associatedObjectType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CollectionResponseSimplePublicObjectId;  }> {
        const localVarPath = this.basePath + '/quotes/{quoteId}/associations/{associatedObjectType}'
            .replace('{' + 'quoteId' + '}', encodeURIComponent(String(quoteId)))
            .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
