...
export class AssociationsApi {
     ...
     */
    public async getAll (quoteId: string, toObjectType: string, after?: string, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CollectionResponseAssociatedIdForwardPaging;  }> {
