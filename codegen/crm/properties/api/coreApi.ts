...
export class CoreApi {
     ...
     * @param propertyName 
     */
    public async deleteCrmV3PropertiesObjectTypePropertyName (objectType: string, propertyName: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
