...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async archive(objectType: string, groupName: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (groupName === null || groupName === undefined) {
            throw new RequiredError("BasicApi", "archive", "groupName");
        }
    ...
    public async create(objectType: string, propertyGroupCreate: PropertyGroupCreate, _options?: Configuration): Promise<RequestContext> {
        ...
        if (propertyGroupCreate === null || propertyGroupCreate === undefined) {
            throw new RequiredError("BasicApi", "create", "propertyGroupCreate");
        }
     ...
     * @param locale 
     */
    public async getAll(objectType: string, locale?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param locale 
     */
    public async getByName(objectType: string, groupName: string, locale?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'objectType' is not null or undefined
        if (objectType === null || objectType === undefined) {
            throw new RequiredError("BasicApi", "getByName", "objectType");
        }


        // verify required parameter 'groupName' is not null or undefined
        if (groupName === null || groupName === undefined) {
            throw new RequiredError("BasicApi", "getByName", "groupName");
        }
    ...
    public async update(objectType: string, groupName: string, propertyGroupUpdate: PropertyGroupUpdate, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'groupName' is not null or undefined
        if (groupName === null || groupName === undefined) {
            throw new RequiredError("BasicApi", "update", "groupName");
        }
        ...
        if (propertyGroupUpdate === null || propertyGroupUpdate === undefined) {
            throw new RequiredError("BasicApi", "update", "propertyGroupUpdate");
        }
...
export class BasicApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createWithHttpInfo(response: ResponseContext): Promise<HttpInfo<PropertyGroup >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getAllWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CollectionResponsePropertyGroupNoPaging >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getByNameWithHttpInfo(response: ResponseContext): Promise<HttpInfo<PropertyGroup >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: PropertyGroup = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateWithHttpInfo(response: ResponseContext): Promise<HttpInfo<PropertyGroup >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: PropertyGroup = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
