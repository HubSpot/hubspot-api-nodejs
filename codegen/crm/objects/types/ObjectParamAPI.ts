...
export class ObjectBasicApi {
    ...
    public getById(param: BasicApiGetByIdRequest, options?: Configuration): Promise<SimplePublicObjectWithAssociations> {
        return this.api.getById(param.objectType, param.objectId, param.properties, param.associations, param.archived, param.idProperty,  options).toPromise();
    }
    ...
    public getPage(param: BasicApiGetPageRequest, options?: Configuration): Promise<CollectionResponseSimplePublicObjectWithAssociationsForwardPaging> {
        return this.api.getPage(param.objectType, param.limit, param.after, param.properties, param.associations, param.archived,  options).toPromise();
    }
