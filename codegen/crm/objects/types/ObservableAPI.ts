...
export class ObservableBasicApi {
     ...
     */
    public getById(objectType: string, objectId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations> {
        const requestContextPromise = this.requestFactory.getById(objectType, objectId, properties, associations, archived, idProperty, _options);
     ...
     * @param archived Whether to return only results that have been archived.
     */
    public getPage(objectType: string, limit?: number, after?: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, _options?: Configuration): Observable<CollectionResponseSimplePublicObjectWithAssociationsForwardPaging> {
        const requestContextPromise = this.requestFactory.getPage(objectType, limit, after, properties, associations, archived, _options);
