...
export class PromiseBasicApi {
     ...
     */
    public getById(objectType: string, objectId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<SimplePublicObjectWithAssociations> {
        const result = this.api.getById(objectType, objectId, properties, associations, archived, idProperty, _options);
        return result.toPromise();
    }
     ...
     * @param archived Whether to return only results that have been archived.
     */
    public getPage(objectType: string, limit?: number, after?: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, _options?: Configuration): Promise<CollectionResponseSimplePublicObjectWithAssociationsForwardPaging> {
        const result = this.api.getPage(objectType, limit, after, properties, associations, archived, _options);
        return result.toPromise();
    }
...
export class PromiseGDPRApi {
     ...
     * @param email 
     */
    public purgeByEmail(objectType: string, email: string, _options?: Configuration): Promise<void> {
        const result = this.api.purgeByEmail(objectType, email, _options);
        return result.toPromise();
    }
     ...
     * @param objectId 
     */
    public purgeById(objectType: string, objectId: number, _options?: Configuration): Promise<void> {
        const result = this.api.purgeById(objectType, objectId, _options);
        return result.toPromise();
    }
