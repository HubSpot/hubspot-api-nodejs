...
export class PromiseAssociationsApi {
     ...
     * @param toObjectId 
     */
    public archive(feedbackSubmissionId: number, toObjectType: string, toObjectId: number, _options?: Configuration): Promise<void> {
     ...
     */
    public create(feedbackSubmissionId: number, toObjectType: string, toObjectId: number, associationSpec: Array<AssociationSpec>, _options?: Configuration): Promise<LabelsBetweenObjectPair> {
     ...
     */
    public getPage(feedbackSubmissionId: number, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<CollectionResponseMultiAssociatedObjectWithLabelForwardPaging> {
