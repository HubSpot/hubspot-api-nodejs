...
export class BasicApi {
     ...
     */
    public async getById (feedbackSubmissionId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SimplePublicObjectWithAssociations;  }> {
        const localVarPath = this.basePath + '/crm/v3/objects/feedback_submissions/{feedbackSubmissionId}'
        ...
        if (feedbackSubmissionId === null || feedbackSubmissionId === undefined) {
            throw new Error('Required parameter feedbackSubmissionId was null or undefined when calling getById.');
        }
    ...
    public async getPage (limit?: number, after?: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CollectionResponseSimplePublicObjectWithAssociationsForwardPaging;  }> {
        const localVarPath = this.basePath + '/crm/v3/objects/feedback_submissions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json', '*/*'];
        // give precedence to 'application/json'
