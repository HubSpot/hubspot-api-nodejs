...
export class BatchApi {
     ...
     */
    public async readBatch (batchReadInputSimplePublicObjectId: BatchReadInputSimplePublicObjectId, archived?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchResponseSimplePublicObject;  }> {
        const localVarPath = this.basePath + '/crm/v3/objects/feedback_submissions/batch/read';
        ...
        if (batchReadInputSimplePublicObjectId === null || batchReadInputSimplePublicObjectId === undefined) {
            throw new Error('Required parameter batchReadInputSimplePublicObjectId was null or undefined when calling readBatch.');
        }
