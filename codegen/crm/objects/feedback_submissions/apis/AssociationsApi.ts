...
export class AssociationsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param toObjectId 
     */
    public async archive(feedbackSubmissionId: number, toObjectType: string, toObjectId: number, _options?: Configuration): Promise<RequestContext> {
        ...
        if (feedbackSubmissionId === null || feedbackSubmissionId === undefined) {
            throw new RequiredError("AssociationsApi", "archive", "feedbackSubmissionId");
        }
     ...
     */
    public async create(feedbackSubmissionId: number, toObjectType: string, toObjectId: number, associationSpec: Array<AssociationSpec>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'feedbackSubmissionId' is not null or undefined
        if (feedbackSubmissionId === null || feedbackSubmissionId === undefined) {
            throw new RequiredError("AssociationsApi", "create", "feedbackSubmissionId");
        }
     ...
     */
    public async getPage(feedbackSubmissionId: number, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'feedbackSubmissionId' is not null or undefined
        if (feedbackSubmissionId === null || feedbackSubmissionId === undefined) {
            throw new RequiredError("AssociationsApi", "getPage", "feedbackSubmissionId");
        }


        // verify required parameter 'toObjectType' is not null or undefined
        if (toObjectType === null || toObjectType === undefined) {
            throw new RequiredError("AssociationsApi", "getPage", "toObjectType");
        }
...
export class AssociationsApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getPage(response: ResponseContext): Promise<CollectionResponseMultiAssociatedObjectWithLabelForwardPaging > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
