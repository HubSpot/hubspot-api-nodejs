...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getById(feedbackSubmissionId: string, archived?: boolean, associations?: Array<string>, idProperty?: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, _options?: Configuration): Promise<RequestContext> {
