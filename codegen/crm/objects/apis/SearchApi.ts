...
export class SearchApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async doSearch(objectType: string, publicObjectSearchRequest: PublicObjectSearchRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'objectType' is not null or undefined
        if (objectType === null || objectType === undefined) {
            throw new RequiredError('Required parameter objectType was null or undefined when calling doSearch.');
        }
