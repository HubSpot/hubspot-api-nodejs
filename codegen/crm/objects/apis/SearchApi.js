...
var SearchApiRequestFactory = (function (_super) {
    ...
    function SearchApiRequestFactory() {
         ...
         */
        this.async = doSearch(objectType, string, publicObjectSearchRequest, PublicObjectSearchRequest_1.PublicObjectSearchRequest, _options ?  : Configuration);
    }
    SearchApiRequestFactory.prototype.Promise = function () {
        var _config = _options || this.configuration;
        // verify required parameter 'objectType' is not null or undefined
        if (objectType === null || objectType === undefined) {
            throw new baseapi_1.RequiredError('Required parameter objectType was null or undefined when calling doSearch.');
        }
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/{objectType}/search'
