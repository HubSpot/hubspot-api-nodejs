...
var BatchApiRequestFactory = (function (_super) {
    ...
    function BatchApiRequestFactory() {
         ...
         */
        this.async = archive(objectType, string, batchInputSimplePublicObjectId, BatchInputSimplePublicObjectId_1.BatchInputSimplePublicObjectId, _options ?  : Configuration);
        /**
         ...
         */
        this.async = create(objectType, string, batchInputSimplePublicObjectInput, BatchInputSimplePublicObjectInput_1.BatchInputSimplePublicObjectInput, _options ?  : Configuration);
        /**
         ...
         */
        this.async = read(objectType, string, batchReadInputSimplePublicObjectId, BatchReadInputSimplePublicObjectId_1.BatchReadInputSimplePublicObjectId, archived ?  : boolean, _options ?  : Configuration);
        /**
         ...
         */
        this.async = update(objectType, string, batchInputSimplePublicObjectBatchInput, BatchInputSimplePublicObjectBatchInput_1.BatchInputSimplePublicObjectBatchInput, _options ?  : Configuration);
    }
    BatchApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/{objectType}/batch/archive'
    ...
    BatchApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/{objectType}/batch/create'
            .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)));
        // Make Request Context
        var requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.POST);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
    ...
    BatchApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/{objectType}/batch/read'
            .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)));
        // Make Request Context
        var requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.POST);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
    ...
    BatchApiRequestFactory.prototype.Promise = function () {
        ...
        // Path Params
        var localVarPath = '/crm/v3/objects/{objectType}/batch/update'
            .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)));
        // Make Request Context
        var requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.POST);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
