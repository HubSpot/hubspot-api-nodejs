...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param archived Whether to return only results that have been archived.
     */
    public async getPage(objectType: string, limit?: number, after?: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
