...
export class PublicObjectApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async merge(objectType: string, publicMergeInput: PublicMergeInput, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'objectType' is not null or undefined
        if (objectType === null || objectType === undefined) {
            throw new RequiredError("PublicObjectApi", "merge", "objectType");
        }
