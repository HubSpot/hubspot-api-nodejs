...
export class BatchApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async create(objectType: string, batchInputSimplePublicObjectInput: BatchInputSimplePublicObjectInput, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
    ...
    public async read(objectType: string, batchReadInputSimplePublicObjectId: BatchReadInputSimplePublicObjectId, archived?: boolean, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'objectType' is not null or undefined
        if (objectType === null || objectType === undefined) {
            throw new RequiredError('Required parameter objectType was null or undefined when calling read.');
        }
