...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['codegen/crm/objects/ApiClient', 'model/BatchInputSimplePublicObjectBatchInput', 'model/BatchInputSimplePublicObjectId', 'model/BatchInputSimplePublicObjectInput', 'model/BatchReadInputSimplePublicObjectId', 'model/BatchResponseSimplePublicObject', 'model/CollectionResponse', 'model/CollectionResponseSimplePublicObject', 'model/CollectionResponseSimplePublicObjectId', 'model/CollectionResponseWithTotalSimplePublicObject', 'model/CompanyInput', 'model/ContactInput', 'model/DealInput', 'model/Error', 'model/ErrorCategory', 'model/ErrorDetail', 'model/Filter', 'model/NextPage', 'model/Paging', 'model/ProductInput', 'model/PublicObjectSearchRequest', 'model/SimplePublicObject', 'model/SimplePublicObjectBatchInput', 'model/SimplePublicObjectId', 'model/SimplePublicObjectInput', 'model/SortField', 'model/StandardError', 'model/TicketInput', 'api/AssociationsApi', 'api/BasicApi', 'api/BatchApi', 'api/CreateNativeObjectsApi', 'api/SearchApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/BatchInputSimplePublicObjectBatchInput'), require('./model/BatchInputSimplePublicObjectId'), require('./model/BatchInputSimplePublicObjectInput'), require('./model/BatchReadInputSimplePublicObjectId'), require('./model/BatchResponseSimplePublicObject'), require('./model/CollectionResponse'), require('./model/CollectionResponseSimplePublicObject'), require('./model/CollectionResponseSimplePublicObjectId'), require('./model/CollectionResponseWithTotalSimplePublicObject'), require('./model/CompanyInput'), require('./model/ContactInput'), require('./model/DealInput'), require('./model/Error'), require('./model/ErrorCategory'), require('./model/ErrorDetail'), require('./model/Filter'), require('./model/NextPage'), require('./model/Paging'), require('./model/ProductInput'), require('./model/PublicObjectSearchRequest'), require('./model/SimplePublicObject'), require('./model/SimplePublicObjectBatchInput'), require('./model/SimplePublicObjectId'), require('./model/SimplePublicObjectInput'), require('./model/SortField'), require('./model/StandardError'), require('./model/TicketInput'), require('./api/AssociationsApi'), require('./api/BasicApi'), require('./api/BatchApi'), require('./api/CreateNativeObjectsApi'), require('./api/SearchApi'));
  }
}(function(ApiClient, BatchInputSimplePublicObjectBatchInput, BatchInputSimplePublicObjectId, BatchInputSimplePublicObjectInput, BatchReadInputSimplePublicObjectId, BatchResponseSimplePublicObject, CollectionResponse, CollectionResponseSimplePublicObject, CollectionResponseSimplePublicObjectId, CollectionResponseWithTotalSimplePublicObject, CompanyInput, ContactInput, DealInput, Error, ErrorCategory, ErrorDetail, Filter, NextPage, Paging, ProductInput, PublicObjectSearchRequest, SimplePublicObject, SimplePublicObjectBatchInput, SimplePublicObjectId, SimplePublicObjectInput, SortField, StandardError, TicketInput, AssociationsApi, BasicApi, BatchApi, CreateNativeObjectsApi, SearchApi) {
  'use strict';

  /**
   * CRM_objects_such_as_companies_contacts_deals_line_items_products_tickets_and_quotes_are_native_objects_in_HubSpots_CRM__These_core_building_blocks_support_custom_properties_store_critical_information_and_play_a_central_role_in_the_HubSpot_application__Supported_Object_TypesThis_API_provides_access_to_collections_of_CRM_objects_which_return_a_map_of_property_names_to_values__Each_object_type_has_its_own_set_of_default_properties_which_can_be_found_by_exploring_the__CRM_Object_Properties_API_httpsdevelopers_hubspot_comdocsmethodscrm_propertiescrm_properties_overview_Object_Type_Properties_returned_by_default______companies__name_domain__contacts__firstname_lastname_email__deals__dealname_amount_closedate_pipeline_dealstage__products__name_description_price__tickets__content_hs_pipeline_hs_pipeline_stage_hs_ticket_category_hs_ticket_priority_subject_Find_a_list_of_all_properties_for_an_object_type_using_the__CRM_Object_Properties_httpsdevelopers_hubspot_comdocsmethodscrm_propertiesget_properties_API__e_g__GET_httpsapi_hubapi_compropertiesv2companiesproperties__Change_the_properties_returned_in_the_response_using_the_properties_array_in_the_request_body_.<br>
