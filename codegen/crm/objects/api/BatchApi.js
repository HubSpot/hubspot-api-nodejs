...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/BatchInputSimplePublicObjectId} opts.batchInputSimplePublicObjectId 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.archiveBatchWithHttpInfo = function(objectType, opts) {
      opts = opts || {};
      var postBody = opts['batchInputSimplePublicObjectId'];
     ...
     * @param {String} objectType 
     * @param {Object} opts Optional parameters
     * @param {module:model/BatchInputSimplePublicObjectInput} opts.batchInputSimplePublicObjectInput 
    ...
    this.createBatchWithHttpInfo = function(objectType, opts) {
      opts = opts || {};
      var postBody = opts['batchInputSimplePublicObjectInput'];
     ...
     * @param {module:model/BatchReadInputSimplePublicObjectId} opts.batchReadInputSimplePublicObjectId 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/BatchResponseSimplePublicObject} and HTTP response
     */
    this.readBatchWithHttpInfo = function(objectType, opts) {
      opts = opts || {};
      var postBody = opts['batchReadInputSimplePublicObjectId'];
     ...
     * @param {String} objectType 
     * @param {Object} opts Optional parameters
     * @param {module:model/BatchInputSimplePublicObjectBatchInput} opts.batchInputSimplePublicObjectBatchInput 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/BatchResponseSimplePublicObject} and HTTP response
     */
    this.updateBatchWithHttpInfo = function(objectType, opts) {
      opts = opts || {};
      var postBody = opts['batchInputSimplePublicObjectBatchInput'];
