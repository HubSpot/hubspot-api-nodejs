...
export class BasicApi {
     ...
     * @param objectId 
     */
    public archive (objectType: string, objectId: string) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     */
    public create (objectType: string, simplePublicObjectInput?: SimplePublicObjectInput) : Promise<{ response: http.IncomingMessage; body: SimplePublicObject;  }> {
     ...
     */
    public getById (objectType: string, objectId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean) : Promise<{ response: http.IncomingMessage; body: SimplePublicObject;  }> {
        const localVarPath = this.basePath + '/{objectType}/{objectId}'
            .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
            .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
        let localVarQueryParameters: any = {};
     ...
     * @param archived Whether to return only results that have been archived.
     */
    public getPage (objectType: string, limit?: number, after?: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean) : Promise<{ response: http.IncomingMessage; body: CollectionResponseSimplePublicObject;  }> {
        const localVarPath = this.basePath + '/{objectType}'
            .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
     ...
     * @param simplePublicObjectInput 
     */
    public update (objectType: string, objectId: string, simplePublicObjectInput?: SimplePublicObjectInput) : Promise<{ response: http.IncomingMessage; body: SimplePublicObject;  }> {
        const localVarPath = this.basePath + '/{objectType}/{objectId}'
            .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
            .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
        let localVarQueryParameters: any = {};
