...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SimplePublicObject', 'model/StandardError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SimplePublicObject'), require('./StandardError'));
  } else {
    // Browser globals (root is window)
    if (!root.CrmObjects) {
      root.CrmObjects = {};
    }
    root.CrmObjects.BatchResponseSimplePublicObject = factory(root.CrmObjects.ApiClient, root.CrmObjects.SimplePublicObject, root.CrmObjects.StandardError);
  }
}(this, function(ApiClient, SimplePublicObject, StandardError) {
  'use strict';
   ...
   * @param errors {Array.<module:model/StandardError>} 
