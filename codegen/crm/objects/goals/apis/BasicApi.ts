...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param goalTargetId 
     */
    public async archive(goalTargetId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'goalTargetId' is not null or undefined
        if (goalTargetId === null || goalTargetId === undefined) {
            throw new RequiredError("BasicApi", "archive", "goalTargetId");
        }
     ...
     */
    public async getById(goalTargetId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'goalTargetId' is not null or undefined
        if (goalTargetId === null || goalTargetId === undefined) {
            throw new RequiredError("BasicApi", "getById", "goalTargetId");
        }
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public async update(goalTargetId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'goalTargetId' is not null or undefined
        if (goalTargetId === null || goalTargetId === undefined) {
            throw new RequiredError("BasicApi", "update", "goalTargetId");
        }
