...
export class PromiseBasicApi {
     ...
     * @param goalTargetId 
     */
    public archiveWithHttpInfo(goalTargetId: string, _options?: Configuration): Promise<HttpInfo<void>> {
        const result = this.api.archiveWithHttpInfo(goalTargetId, _options);
     ...
     * @param goalTargetId 
     */
    public archive(goalTargetId: string, _options?: Configuration): Promise<void> {
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public updateWithHttpInfo(goalTargetId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<HttpInfo<SimplePublicObject>> {
        const result = this.api.updateWithHttpInfo(goalTargetId, simplePublicObjectInput, idProperty, _options);
        return result.toPromise();
    }
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public update(goalTargetId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<SimplePublicObject> {
