...
export class PromiseBasicApi {
     ...
     * @param goalTargetId
     */
    public archiveWithHttpInfo(goalTargetId: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<void>> {
        ...
        const result = this.api.archiveWithHttpInfo(goalTargetId, observableOptions);
     ...
     * @param goalTargetId
     */
    public archive(goalTargetId: string, _options?: PromiseConfigurationOptions): Promise<void> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.archive(goalTargetId, observableOptions);
        return result.toPromise();
    }
     ...
     */
    public getByIdWithHttpInfo(goalTargetId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<SimplePublicObjectWithAssociations>> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.getByIdWithHttpInfo(goalTargetId, properties, propertiesWithHistory, associations, archived, idProperty, observableOptions);
        return result.toPromise();
    }
     ...
     * @param [idProperty] The name of a property whose values are unique for this object
     */
    public getById(goalTargetId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: PromiseConfigurationOptions): Promise<SimplePublicObjectWithAssociations> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.getById(goalTargetId, properties, propertiesWithHistory, associations, archived, idProperty, observableOptions);
        return result.toPromise();
    }
     ...
     * @param [idProperty] The name of a property whose values are unique for this object
     */
    public updateWithHttpInfo(goalTargetId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<SimplePublicObject>> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.updateWithHttpInfo(goalTargetId, simplePublicObjectInput, idProperty, observableOptions);
        return result.toPromise();
    }
     ...
     * @param [idProperty] The name of a property whose values are unique for this object
     */
    public update(goalTargetId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: PromiseConfigurationOptions): Promise<SimplePublicObject> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.update(goalTargetId, simplePublicObjectInput, idProperty, observableOptions);
        return result.toPromise();
    }
