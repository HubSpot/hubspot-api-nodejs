...
export class ObservableAssociationsApi {
     ...
     */
    public archive(noteId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<void> {
     ...
     * @param associationType 
     */
    public create(noteId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations> {
     ...
     */
    public getAll(noteId: string, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Observable<CollectionResponseAssociatedIdForwardPaging> {
