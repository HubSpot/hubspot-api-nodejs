...
export class ObservableAssociationsApi {
     ...
     * @param toObjectId 
     */
    public archive(taskId: number, toObjectType: string, toObjectId: number, _options?: Configuration): Observable<void> {
     ...
     */
    public create(taskId: number, toObjectType: string, toObjectId: number, associationSpec: Array<AssociationSpec>, _options?: Configuration): Observable<LabelsBetweenObjectPair> {
    ...
    /**
     * List all associations of a task by object type. Limit 1000 per call.
     * List
     * @param taskId 
     * @param toObjectType 
     ...
     */
    public getAll(taskId: number, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Observable<CollectionResponseMultiAssociatedObjectWithLabelForwardPaging> {
