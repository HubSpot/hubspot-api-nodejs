...
export class PromiseBasicApi {
     ...
     * @param taskId
     */
    public archiveWithHttpInfo(taskId: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<void>> {
        ...
        const result = this.api.archiveWithHttpInfo(taskId, observableOptions);
     ...
     * @param taskId
     */
    public archive(taskId: string, _options?: PromiseConfigurationOptions): Promise<void> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.archive(taskId, observableOptions);
        return result.toPromise();
    }
     ...
     */
    public getByIdWithHttpInfo(taskId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<SimplePublicObjectWithAssociations>> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.getByIdWithHttpInfo(taskId, properties, propertiesWithHistory, associations, archived, idProperty, observableOptions);
        return result.toPromise();
    }
     ...
     * @param [idProperty] The name of a property whose values are unique for this object
     */
    public getById(taskId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: PromiseConfigurationOptions): Promise<SimplePublicObjectWithAssociations> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.getById(taskId, properties, propertiesWithHistory, associations, archived, idProperty, observableOptions);
        return result.toPromise();
    }
     ...
     * @param [idProperty] The name of a property whose values are unique for this object
     */
    public updateWithHttpInfo(taskId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<SimplePublicObject>> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.updateWithHttpInfo(taskId, simplePublicObjectInput, idProperty, observableOptions);
        return result.toPromise();
    }
     ...
     * @param [idProperty] The name of a property whose values are unique for this object
     */
    public update(taskId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: PromiseConfigurationOptions): Promise<SimplePublicObject> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.update(taskId, simplePublicObjectInput, idProperty, observableOptions);
        return result.toPromise();
    }
