...
export class ObservableBasicApi {
     ...
     * @param meetingId
     */
    public archiveWithHttpInfo(meetingId: string, _options?: ConfigurationOptions): Observable<HttpInfo<void>> {
     ...
     * @param meetingId
     */
    public archive(meetingId: string, _options?: ConfigurationOptions): Observable<void> {
        return this.archiveWithHttpInfo(meetingId, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
     ...
     */
    public getByIdWithHttpInfo(meetingId: string, archived?: boolean, associations?: Array<string>, idProperty?: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, _options?: ConfigurationOptions): Observable<HttpInfo<SimplePublicObjectWithAssociations>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [...this.configuration.middleware];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware
        ...
        const requestContextPromise = this.requestFactory.getById(meetingId, archived, associations, idProperty, properties, propertiesWithHistory, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [propertiesWithHistory] A comma separated list of the properties to be returned along with their history of previous values. If any of the specified properties are not present on the requested object(s), they will be ignored.
     */
    public getById(meetingId: string, archived?: boolean, associations?: Array<string>, idProperty?: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, _options?: ConfigurationOptions): Observable<SimplePublicObjectWithAssociations> {
        return this.getByIdWithHttpInfo(meetingId, archived, associations, idProperty, properties, propertiesWithHistory, _options).pipe(map((apiResponse: HttpInfo<SimplePublicObjectWithAssociations>) => apiResponse.data));
    }
     ...
     * @param [idProperty] The name of a property whose values are unique for this object type
     */
    public updateWithHttpInfo(meetingId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: ConfigurationOptions): Observable<HttpInfo<SimplePublicObject>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [...this.configuration.middleware];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param [idProperty] The name of a property whose values are unique for this object type
     */
    public update(meetingId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: ConfigurationOptions): Observable<SimplePublicObject> {
        return this.updateWithHttpInfo(meetingId, simplePublicObjectInput, idProperty, _options).pipe(map((apiResponse: HttpInfo<SimplePublicObject>) => apiResponse.data));
    }
