...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param leadsId 
     */
    public async archive(leadsId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'leadsId' is not null or undefined
        if (leadsId === null || leadsId === undefined) {
            throw new RequiredError("BasicApi", "archive", "leadsId");
        }
     ...
     */
    public async getById(leadsId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'leadsId' is not null or undefined
        if (leadsId === null || leadsId === undefined) {
            throw new RequiredError("BasicApi", "getById", "leadsId");
        }
     ...
     * @param idProperty The name of a property whose values are unique for this object
     */
    public async update(leadsId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'leadsId' is not null or undefined
        if (leadsId === null || leadsId === undefined) {
            throw new RequiredError("BasicApi", "update", "leadsId");
        }
