...
export class PromiseAssociationsApi {
     ...
     * @param toObjectId 
     */
    public archive(callId: number, toObjectType: string, toObjectId: number, _options?: Configuration): Promise<void> {
     ...
     */
    public create(callId: number, toObjectType: string, toObjectId: number, associationSpec: Array<AssociationSpec>, _options?: Configuration): Promise<LabelsBetweenObjectPair> {
     ...
     */
    public getAll(callId: number, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<CollectionResponseMultiAssociatedObjectWithLabelForwardPaging> {
