...
export class PromiseAssociationsApi {
     ...
     */
    public archive(callId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Promise<void> {
        const result = this.api.archive(callId, toObjectType, toObjectId, associationType, _options);
     ...
     * @param associationType 
     */
    public create(callId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Promise<SimplePublicObjectWithAssociations> {
        const result = this.api.create(callId, toObjectType, toObjectId, associationType, _options);
        return result.toPromise();
    }
     ...
     */
    public getAll(callId: string, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<CollectionResponseAssociatedIdForwardPaging> {
...
export class PromiseBasicApi {
     ...
     * @param callId 
     */
    public archive(callId: string, _options?: Configuration): Promise<void> {
     ...
     */
    public getById(callId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<SimplePublicObjectWithAssociations> {
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public update(callId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<SimplePublicObject> {
