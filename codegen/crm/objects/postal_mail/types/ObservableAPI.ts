...
export class ObservableAssociationsApi {
     ...
     * @param toObjectId 
     */
    public archive(postalMail: number, toObjectType: string, toObjectId: number, _options?: Configuration): Observable<void> {
     ...
     */
    public create(postalMail: number, toObjectType: string, toObjectId: number, associationSpec: Array<AssociationSpec>, _options?: Configuration): Observable<LabelsBetweenObjectPair> {
     ...
     */
    public getAll(postalMail: number, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Observable<CollectionResponseMultiAssociatedObjectWithLabelForwardPaging> {
...
export class ObservableBasicApi {
     ...
     * @param postalMail 
     */
    public archive(postalMail: string, _options?: Configuration): Observable<void> {
     ...
     */
    public getById(postalMail: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations> {
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public update(postalMail: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<SimplePublicObject> {
