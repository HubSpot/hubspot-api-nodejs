...
export class AssociationsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param toObjectId 
     */
    public async archive(postalMail: number, toObjectType: string, toObjectId: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'postalMail' is not null or undefined
        if (postalMail === null || postalMail === undefined) {
            throw new RequiredError("AssociationsApi", "archive", "postalMail");
        }
     ...
     */
    public async create(postalMail: number, toObjectType: string, toObjectId: number, associationSpec: Array<AssociationSpec>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'postalMail' is not null or undefined
        if (postalMail === null || postalMail === undefined) {
            throw new RequiredError("AssociationsApi", "create", "postalMail");
        }
     ...
     */
    public async getAll(postalMail: number, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'postalMail' is not null or undefined
        if (postalMail === null || postalMail === undefined) {
            throw new RequiredError("AssociationsApi", "getAll", "postalMail");
        }
