...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getById(postalMailId: string, archived?: boolean, associations?: Array<string>, idProperty?: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
