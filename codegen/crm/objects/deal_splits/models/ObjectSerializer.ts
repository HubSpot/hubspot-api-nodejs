...
let enumsMap: Set<string> = new Set<string>([
    "BatchResponseDealToDealSplitsStatusEnum",
    "BatchResponseDealToDealSplitsWithErrorsStatusEnum",
]);

let typeMap: {[index: string]: any} = {
    "BatchInputPublicObjectId": BatchInputPublicObjectId,
    "BatchResponseDealToDealSplits": BatchResponseDealToDealSplits,
    "BatchResponseDealToDealSplitsWithErrors": BatchResponseDealToDealSplitsWithErrors,
    "DealToDealSplits": DealToDealSplits,
    "ErrorDetail": ErrorDetail,
    "ModelError": ModelError,
    "PublicDealSplitInput": PublicDealSplitInput,
    "PublicDealSplitsBatchCreateRequest": PublicDealSplitsBatchCreateRequest,
    "PublicDealSplitsCreateRequest": PublicDealSplitsCreateRequest,
