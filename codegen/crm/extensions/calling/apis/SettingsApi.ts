...
export class SettingsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async create(appId: number, settingsRequest: SettingsRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        if (settingsRequest === null || settingsRequest === undefined) {
            throw new RequiredError('Required parameter settingsRequest was null or undefined when calling create.');
        }
    ...
    public async update(appId: number, settingsPatchRequest: SettingsPatchRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        if (settingsPatchRequest === null || settingsPatchRequest === undefined) {
            throw new RequiredError('Required parameter settingsPatchRequest was null or undefined when calling update.');
        }
...
export class SettingsApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async create(response: ResponseContext): Promise<SettingsResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getById(response: ResponseContext): Promise<SettingsResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SettingsResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async update(response: ResponseContext): Promise<SettingsResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SettingsResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
