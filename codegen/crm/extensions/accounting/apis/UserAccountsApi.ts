 ...
 * no description
 */
export class UserAccountsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async archive(accountId: string, _options?: Configuration): Promise<RequestContext> {
     ...
     */
    public async replace(createUserAccountRequestExternal: CreateUserAccountRequestExternal, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(createUserAccountRequestExternal, "CreateUserAccountRequestExternal", ""),
            contentType
        );
...
export class UserAccountsApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async replaceWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
