...
let defaultBasePath = 'https://api.hubapi.com/crm/v3/extensions/cards';
...
export class CardsApi {
    ...
    public async archive (cardId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/{appId}/{cardId}'
    ...
    public async create (cardCreateRequest?: CardCreateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CardResponse;  }> {
        const localVarPath = this.basePath + '/{appId}';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary Get a card.
     * @param cardId ID of the target card.
     */
