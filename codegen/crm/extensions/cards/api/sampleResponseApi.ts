...
export class SampleResponseApi {
    ...
    public setApiKey(key: SampleResponseApiApiKeys, value: string) {
        (this.authentications as any)[SampleResponseApiApiKeys[key]].apiKey = value;
    }
    ...
    public async getCardsSampleResponse (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IntegratorCardPayloadResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: IntegratorCardPayloadResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "IntegratorCardPayloadResponse");
