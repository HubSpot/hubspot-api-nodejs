...
export class MembershipsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async addAllFromList(listId: string, sourceListId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async getLists(objectTypeId: string, recordId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'objectTypeId' is not null or undefined
        if (objectTypeId === null || objectTypeId === undefined) {
            throw new RequiredError("MembershipsApi", "getLists", "objectTypeId");
        }


        // verify required parameter 'recordId' is not null or undefined
        if (recordId === null || recordId === undefined) {
            throw new RequiredError("MembershipsApi", "getLists", "recordId");
        }
     ...
     */
    public async getPage(listId: string, after?: string, before?: string, limit?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param limit The number of records to return in the response. The maximum &#x60;limit&#x60; is 250.
     */
    public async getPageOrderedByAddedToListDate(listId: string, after?: string, before?: string, limit?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'listId' is not null or undefined
        if (listId === null || listId === undefined) {
            throw new RequiredError("MembershipsApi", "getPageOrderedByAddedToListDate", "listId");
        }
     ...
     * @param listId The **ILS ID** of the &#x60;MANUAL&#x60; or &#x60;SNAPSHOT&#x60; list.
     */
    public async removeAll(listId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class MembershipsApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getLists
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getListsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ApiCollectionResponseRecordListMembershipNoPaging >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ApiCollectionResponseRecordListMembershipNoPaging = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "ApiCollectionResponseRecordListMembershipNoPaging", ""
            ) as ApiCollectionResponseRecordListMembershipNoPaging;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("0", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getPageWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ApiCollectionResponseJoinTimeAndRecordId >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getPageOrderedByAddedToListDate
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getPageOrderedByAddedToListDateWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ApiCollectionResponseJoinTimeAndRecordId >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ApiCollectionResponseJoinTimeAndRecordId = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
