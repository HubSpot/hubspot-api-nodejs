...
export class ObservableListsApi {
     ...
     */
    public _delete(listId: number, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory._delete(listId, _options);
    ...
    public restore(listId: number, _options?: Configuration): Observable<void> {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.restore(rsp)));
            }));
    }
    ...
    public updateListFilters(listId: number, listFilterUpdateRequest: ListFilterUpdateRequest, enrollObjectsInWorkflows?: boolean, _options?: Configuration): Observable<ListUpdateResponse> {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.updateListFilters(rsp)));
            }));
    }
    ...
    public updateName(listId: number, listName?: string, includeFilters?: boolean, _options?: Configuration): Observable<ListUpdateResponse> {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.updateName(rsp)));
            }));
    }
...
export class ObservableMembershipsApi {
    ...
    public add(listId: number, requestBody: Array<number>, _options?: Configuration): Observable<MembershipsUpdateResponse> {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.add(rsp)));
            }));
    }
    ...
    public addAllFromList(listId: number, sourceListId: number, _options?: Configuration): Observable<void> {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.addAllFromList(rsp)));
            }));
    }
    ...
    public addAndRemove(listId: number, membershipChangeRequest: MembershipChangeRequest, _options?: Configuration): Observable<MembershipsUpdateResponse> {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.addAndRemove(rsp)));
            }));
    }
     ...
     * @param listId The **ILS ID** of the &#x60;MANUAL&#x60; or &#x60;SNAPSHOT&#x60; list.
     */
    public deleteAll(listId: number, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deleteAll(listId, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.deleteAll(rsp)));
            }));
    }
    ...
    public remove(listId: number, requestBody: Array<number>, _options?: Configuration): Observable<MembershipsUpdateResponse> {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.remove(rsp)));
            }));
    }
