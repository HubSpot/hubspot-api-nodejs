...
let typeMap: {[index: string]: any} = {
    "CollectionResponsePublicPermissionSetNoPaging": CollectionResponsePublicPermissionSetNoPaging,
    "CollectionResponsePublicTeamNoPaging": CollectionResponsePublicTeamNoPaging,
    "CollectionResponsePublicUserForwardPaging": CollectionResponsePublicUserForwardPaging,
    "ErrorDetail": ErrorDetail,
    "ForwardPaging": ForwardPaging,
    "ModelError": ModelError,
    "NextPage": NextPage,
    "PublicPermissionSet": PublicPermissionSet,
