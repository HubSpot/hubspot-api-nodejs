...
let typeMap: {[index: string]: any} = {
    "CollectionResponsePublicBusinessUnitNoPaging": CollectionResponsePublicBusinessUnitNoPaging,
    "ErrorDetail": ErrorDetail,
    "ModelError": ModelError,
    "PublicBusinessUnit": PublicBusinessUnit,
    "PublicBusinessUnitLogoMetadata": PublicBusinessUnitLogoMetadata,
}
