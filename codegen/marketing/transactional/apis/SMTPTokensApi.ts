 ...
 * no description
 */
export class SMTPTokensApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async archiveToken(tokenId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (tokenId === null || tokenId === undefined) {
            throw new RequiredError("SMTPTokensApi", "archiveToken", "tokenId");
        }
    ...
    public async createToken(smtpApiTokenRequestEgg: SmtpApiTokenRequestEgg, _options?: Configuration): Promise<RequestContext> {
        ...
        if (smtpApiTokenRequestEgg === null || smtpApiTokenRequestEgg === undefined) {
            throw new RequiredError("SMTPTokensApi", "createToken", "smtpApiTokenRequestEgg");
        }
    ...
    public async getTokenById(tokenId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'tokenId' is not null or undefined
        if (tokenId === null || tokenId === undefined) {
            throw new RequiredError("SMTPTokensApi", "getTokenById", "tokenId");
        }
     ...
     */
    public async getTokensPage(after?: string, campaignName?: string, emailCampaignId?: string, limit?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
    ...
    public async resetPassword(tokenId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'tokenId' is not null or undefined
        if (tokenId === null || tokenId === undefined) {
            throw new RequiredError("SMTPTokensApi", "resetPassword", "tokenId");
        }
...
export class SMTPTokensApiResponseProcessor {
