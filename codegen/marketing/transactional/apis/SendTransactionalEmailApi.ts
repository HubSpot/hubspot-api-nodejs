 ...
 * no description
 */
export class SendTransactionalEmailApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async sendEmail(publicSingleSendRequestEgg: PublicSingleSendRequestEgg, _options?: Configuration): Promise<RequestContext> {
        ...
        if (publicSingleSendRequestEgg === null || publicSingleSendRequestEgg === undefined) {
            throw new RequiredError("SendTransactionalEmailApi", "sendEmail", "publicSingleSendRequestEgg");
        }
...
export class SendTransactionalEmailApiResponseProcessor {
     ...
     */
     public async sendEmailWithHttpInfo(response: ResponseContext): Promise<HttpInfo<EmailSendStatusView >> {
