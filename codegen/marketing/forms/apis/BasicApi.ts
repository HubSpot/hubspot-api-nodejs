...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async archive(formId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (formId === null || formId === undefined) {
            throw new RequiredError("BasicApi", "archive", "formId");
        }
    ...
    public async getById(formId: string, archived?: boolean, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'formId' is not null or undefined
        if (formId === null || formId === undefined) {
            throw new RequiredError("BasicApi", "getById", "formId");
        }
     ...
     * @param limit 
     */
    public async marketingV3Forms(after?: string, archived?: boolean, formTypes?: Array<'hubspot' | 'captured' | 'flow' | 'blog_comment' | 'all'>, limit?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (formTypes !== undefined) {
            const serializedParams = ObjectSerializer.serialize(formTypes, "Array<'hubspot' | 'captured' | 'flow' | 'blog_comment' | 'all'>", "");
     ...
     */
    public async marketingV3Forms_1(formDefinitionCreateRequestBase: FormDefinitionCreateRequestBase, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (formDefinitionCreateRequestBase === null || formDefinitionCreateRequestBase === undefined) {
            throw new RequiredError("BasicApi", "marketingV3Forms_1", "formDefinitionCreateRequestBase");
        }
    ...
    public async replace(formId: string, hubSpotFormDefinition: HubSpotFormDefinition, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'formId' is not null or undefined
        if (formId === null || formId === undefined) {
            throw new RequiredError("BasicApi", "replace", "formId");
        }
        ...
        if (hubSpotFormDefinition === null || hubSpotFormDefinition === undefined) {
            throw new RequiredError("BasicApi", "replace", "hubSpotFormDefinition");
        }
    ...
    public async update(formId: string, hubSpotFormDefinitionPatchRequest: HubSpotFormDefinitionPatchRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'formId' is not null or undefined
        if (formId === null || formId === undefined) {
            throw new RequiredError("BasicApi", "update", "formId");
        }
        ...
        if (hubSpotFormDefinitionPatchRequest === null || hubSpotFormDefinitionPatchRequest === undefined) {
            throw new RequiredError("BasicApi", "update", "hubSpotFormDefinitionPatchRequest");
        }
...
export class BasicApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to marketingV3Forms
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async marketingV3FormsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CollectionResponseFormDefinitionBaseForwardPaging >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to marketingV3Forms_1
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async marketingV3Forms_1WithHttpInfo(response: ResponseContext): Promise<HttpInfo<FormDefinitionBase >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
