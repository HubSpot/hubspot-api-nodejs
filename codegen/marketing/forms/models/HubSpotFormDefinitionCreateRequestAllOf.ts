...
export class HubSpotFormDefinitionCreateRequestAllOf {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "formType",
            "baseName": "formType",
            "type": "HubSpotFormDefinitionCreateRequestAllOfFormTypeEnum",
            "format": ""
        },
        {
            "name": "name",
    ...
    static getAttributeTypeMap() {
        return HubSpotFormDefinitionCreateRequestAllOf.attributeTypeMap;
    }
