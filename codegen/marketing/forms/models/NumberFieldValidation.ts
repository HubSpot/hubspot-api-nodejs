...
export class NumberFieldValidation {
    /**
    * The maximum number of digits allowed for number field input. Must be greater than or equal to minAllowedDigits.
    */
    'maxAllowedDigits': number;
    /**
    * The minimum number of digits required for valid number field input. Must be less than or equal to maxAllowedDigits.
    */
