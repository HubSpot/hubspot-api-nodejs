...
export class ParticipantStateApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getParticipationsBreakdownByContactId(contactIdentifier: string, after?: string, limit?: number, state?: string, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param state The participation state value. It may be REGISTERED, CANCELLED, ATTENDED, NO_SHOW
     */
    public async getParticipationsBreakdownByExternalEventId(externalAccountId: string, externalEventId: string, after?: string, contactIdentifier?: string, limit?: number, state?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param state The participation state value. It may be REGISTERED, CANCELLED, ATTENDED, NO_SHOW
     */
    public async getParticipationsBreakdownByMarketingEventId(marketingEventId: number, after?: string, contactIdentifier?: string, limit?: number, state?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class ParticipantStateApiResponseProcessor {
     ...
     */
     public async getParticipationsBreakdownByContactIdWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CollectionResponseWithTotalParticipationBreakdown >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: CollectionResponseWithTotalParticipationBreakdown = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "CollectionResponseWithTotalParticipationBreakdown", ""
            ) as CollectionResponseWithTotalParticipationBreakdown;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getParticipationsBreakdownByExternalEventIdWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CollectionResponseWithTotalParticipationBreakdown >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: CollectionResponseWithTotalParticipationBreakdown = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getParticipationsBreakdownByMarketingEventIdWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CollectionResponseWithTotalParticipationBreakdown >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: CollectionResponseWithTotalParticipationBreakdown = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
