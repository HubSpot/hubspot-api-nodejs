...
describe('api client', () => {
  it('is discoverable', () => {
    ...
    expect(BasicApi.name).toBe(client.addEventAttendeesApi.constructor.name)
    ...
    expect(BasicApi.name).toBe(client.changePropertyApi.constructor.name)
    ...
    expect(BasicApi.name).toBe(client.retrieveParticipantStateApi.constructor.name)
